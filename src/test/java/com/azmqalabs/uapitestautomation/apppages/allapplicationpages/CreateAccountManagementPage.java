...
public class CreateAccountManagementPage extends BasePage {
    ...
    public void selectServicesFromAllServices(Map<Object, Object> testdatamap) {
    ...
    public void DeselectServicesFromAllServices(Map<Object, Object> testdatamap) {
        String deSelectServices = testdatamap.get("DeSelectService").toString();
        String[] deSelectService = deSelectServices.split(",");
        for (String service : deSelectService) {
    ...
    public void verifySelectedServices(Map<Object, Object> testdatamap) throws Exception {
        String allServices = testdatamap.get("AllServices").toString();
        String[] allService = allServices.split(",");
    ...
    public void verifyDeSelectedServicesAreNotDisplayed(Map<Object, Object> testdatamap) throws Exception {
        String deSelectServices = testdatamap.get("DeSelectService").toString();
        String[] deSelectService = deSelectServices.split(",");
        for (String service : deSelectService) {
    ...
    public void selectAnnualSubscriptionTiers(Map<Object, Object> testdatamap) throws InterruptedException {
        String annual = testdatamap.get("AnnualPackages").toString();
        String[] annualPackages = annual.split(",");
    ...
    public void verifySelectedAnnualSubscriptionTiers(Map<Object, Object> testdatamap) throws Exception {
        String annual = testdatamap.get("AnnualPackages").toString();
        String[] annualPackages = annual.split(",");
        for (String annualPackage : annualPackages) {
    ...
    public void selectServiceBundles(Map<Object, Object> testdatamap) throws InterruptedException {
        String service = testdatamap.get("ServicePackages").toString();
        String[] servicePackages = service.split(",");
    ...
    public void verifySelectServiceBundles(Map<Object, Object> testdatamap) throws Exception {
        String service = testdatamap.get("ServicePackages").toString();
        String[] servicePackages = service.split(",");
        for (String servicePackage : servicePackages) {
    ...
    public void selectServiceProviders(Map<Object, Object> testdatamap) {
        String allServiceProviders = testdatamap.get("AllServiceProviders").toString();
        String[] serviceProviders = allServiceProviders.split(",");
    ...
    public void verifySelectedServiceProviders(Map<Object, Object> testdatamap) throws Exception {
        String allServiceProviders = testdatamap.get("AllServiceProviders").toString();
        String[] serviceProviders = allServiceProviders.split(",");
        for (String serviceProvider : serviceProviders) {
    ...
    public void verifyAllActiveServiceProvidersInSettingsTab(Map<Object, Object> testdatamap, Log Log) {
        try {
            WebElement element = driver.findElement(By.xpath(UapiOR.Admin_CreateAccountManagement_Page_SettingsAllServiceProviders));
            scrollToElement(driver, element);
            Thread.sleep(2000);
            this.takeScreenShot();
            String expectedActiveServiceProviders = testdatamap.get("ActiveServiceProviders").toString();
            String[] expectedServiceProviders = expectedActiveServiceProviders.split(",");
    ...
    public void deSelectServiceProviders(Map<Object, Object> testdatamap) {
        String deselectServiceProvider = testdatamap.get("DeselectServiceProvider").toString();
        String[] serviceProviders = deselectServiceProvider.split(",");
        for (String serviceProvider : serviceProviders) {
    ...
    // Method to verify deselected Services
    public void verifyDeSelectedServiceProvidersAreNotDisplayed(Map<Object, Object> testdatamap) throws Exception {
        String deselectServiceProvider = testdatamap.get("DeselectServiceProvider").toString();
        String[] serviceProviders = deselectServiceProvider.split(",");
        for (String serviceProvider : serviceProviders) {
    ...
    public void verifyErrorMessageInCreateAccountManagementScreen(Map<Object, Object> testdatamap, Log Log) throws InterruptedException {
        try {
            ...
            selectAnnualSubscriptionTiers(testdatamap);
            clickOnServiceBundles(Log);
            selectServiceBundles(testdatamap);
            selectServicesFromAllServices(testdatamap);
