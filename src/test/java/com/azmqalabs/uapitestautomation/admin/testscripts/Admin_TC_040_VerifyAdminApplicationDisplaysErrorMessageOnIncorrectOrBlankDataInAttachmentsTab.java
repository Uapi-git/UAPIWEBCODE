/**
*
* Test Script Name                      : Admin_TC_040_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDataInAttachmentsTab
* TestDataSheet                         : Admin_TC_040
* Objective                             : Verify whether UAPI Admin application displays valid error message on incorrect details or blank data in mandatory field in 'Attachments' tab
* Version                               : 1.0
...
public class Admin_TC_040_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDataInAttachmentsTab {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_040";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_040_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDataInAttachmentsTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.verifyAttachAttachmentsErrorMessage(Log);
