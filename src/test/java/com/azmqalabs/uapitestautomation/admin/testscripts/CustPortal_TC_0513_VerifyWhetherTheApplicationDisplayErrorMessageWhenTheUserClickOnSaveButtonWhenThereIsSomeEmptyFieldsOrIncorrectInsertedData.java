/**
 * Test Script Name                      : CustPortal_TC_0513_VerifyWhetherTheApplicationDisplayErrorMessageWhenTheUserClickOnSaveButtonWhenThereIsSomeEmptyFieldsOrIncorrectInsertedData.
 * Test data sheet Name                  : CustPortal_TC_0513
 * Objective                             : Verify whether the Application display error message when the user click on 'Save' button when there is some empty fields or incorrect inserted data.
 * Version                               : 1.0
...
public class CustPortal_TC_0513_VerifyWhetherTheApplicationDisplayErrorMessageWhenTheUserClickOnSaveButtonWhenThereIsSomeEmptyFieldsOrIncorrectInsertedData {
    // DECLARATION SECTION
    static String TestDataTab = "CustPortal_TC_0513";
    ...
    public CustPortal_TC_0513_VerifyWhetherTheApplicationDisplayErrorMessageWhenTheUserClickOnSaveButtonWhenThereIsSomeEmptyFieldsOrIncorrectInsertedData(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.createUserPage.enterInvalidDataInCreateUserPageAndVerifyErrorMSGInDevPortal(testdatamap,Log);
