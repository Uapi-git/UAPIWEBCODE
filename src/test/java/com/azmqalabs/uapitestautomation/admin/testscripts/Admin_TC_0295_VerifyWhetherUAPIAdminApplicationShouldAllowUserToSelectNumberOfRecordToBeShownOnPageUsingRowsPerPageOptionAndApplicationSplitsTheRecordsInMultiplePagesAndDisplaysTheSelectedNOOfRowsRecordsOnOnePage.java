/**
 * Test Script Name                      : Admin_TC_0295_VerifyWhetherUAPIAdminApplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationSplitsTheRecordsInMultiplePagesAndDisplaysTheSelectedNOOfRowsRecordsOnOnePage.
 * Test data sheet Name                  : Admin_TC_0295
...
public class Admin_TC_0295_VerifyWhetherUAPIAdminApplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationSplitsTheRecordsInMultiplePagesAndDisplaysTheSelectedNOOfRowsRecordsOnOnePage {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0295";
    ...
    public Admin_TC_0295_VerifyWhetherUAPIAdminApplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationSplitsTheRecordsInMultiplePagesAndDisplaysTheSelectedNOOfRowsRecordsOnOnePage(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.clickOnClientSubscriptionsMenu(Log);
            Pages.reportsPage.verifyDataFieldsUnderClientSubscription(Log);
            Pages.reportsPage.selectRowsPerPageInClientSubscription(5,Log);
            Pages.reportsPage.clickOnNextPageIconInTable(Log);
            Pages.reportsPage.clickOnPreviousPageIconInTable(Log);
            Pages.reportsPage.VerifyApplicationRetrievesDataSelectedRowsPerPageInClientSubscriptionPage(5,Log);
