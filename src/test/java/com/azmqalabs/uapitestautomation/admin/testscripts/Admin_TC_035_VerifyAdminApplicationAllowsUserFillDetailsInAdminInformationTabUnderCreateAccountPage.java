/**
*
* Test Script Name                      : Admin_TC_035_VerifyAdminApplicationAllowsUserFillDetailsInAdminInformationTabUnderCreateAccountPage
* TestDataSheet                         : Admin_TC_035
* Objective                             : Verify whether user should be able to fill below details in 'Admin Information' tab under 'Create Account' page.
* Version                               : 1.0
...
public class Admin_TC_035_VerifyAdminApplicationAllowsUserFillDetailsInAdminInformationTabUnderCreateAccountPage {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_035";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_035_VerifyAdminApplicationAllowsUserFillDetailsInAdminInformationTabUnderCreateAccountPage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.clickOnAdminInformationTab();
