/**
 * Test Script Name                      : CustPortal_TC_0505_VerifyWhetherApplicationDisplaysBelowUserDetailsInEditableModeWhenUserClicksOnEditOptionUnderActionMenuFirstNameLastNameNationalIDMobileNumberRoleStatus.
 * Test data sheet Name                  : CustPortal_TC_0505
 * Objective                             : Verify whether Application displays below User details in editable mode when user clicks on 'Edit' option under Action menu. First Name,Last Name,National ID,Mobile Number,Role,Status
 * Version                               : 1.0
...
public class CustPortal_TC_0505_VerifyWhetherApplicationDisplaysBelowUserDetailsInEditableModeWhenUserClicksOnEditOptionUnderActionMenuFirstNameLastNameNationalIDMobileNumberRoleStatus {
    // DECLARATION SECTION
    static String TestDataTab = "CustPortal_TC_0505";
    ...
    public CustPortal_TC_0505_VerifyWhetherApplicationDisplaysBelowUserDetailsInEditableModeWhenUserClicksOnEditOptionUnderActionMenuFirstNameLastNameNationalIDMobileNumberRoleStatus(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.customerUserManagementPage.verifyEditModeAfterClickOnEditFromActionList();
