/**
*
* Test Script Name                      : Admin_TC_0174_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditServiceHeadListScreenAndRedirectsToServiceHeadListScreen
* TestDataSheet                         : Admin_TC_0174
* Objective                             : Verify whether UAPI Admin Application closes the screen and redirects to 'Service Heads List' screen when user clicks on 'Cancel' Button under Edit Service Heads List screen
* Version                               : 1.0
...
public class Admin_TC_0174_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditServiceHeadListScreenAndRedirectsToServiceHeadListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0174";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0174_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditServiceHeadListScreenAndRedirectsToServiceHeadListScreen(Map<Object, Object> testdatamap){
