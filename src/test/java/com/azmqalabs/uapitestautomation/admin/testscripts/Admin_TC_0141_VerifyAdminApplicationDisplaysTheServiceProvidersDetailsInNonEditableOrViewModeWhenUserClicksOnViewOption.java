/**
*
* Test Script Name                      : Admin_TC_0141_VerifyAdminApplicationDisplaysTheServiceProvidersDetailsInNonEditableOrViewModeWhenUserClicksOnViewOption
* TestDataSheet                         : Admin_TC_0141
* Objective                             : Verify whether UAPI Admin Application displays the Service Providers details in non-editable or view mode when user clicks on 'View' option under Action menu.
* Version                               : 1.0
...
public class Admin_TC_0141_VerifyAdminApplicationDisplaysTheServiceProvidersDetailsInNonEditableOrViewModeWhenUserClicksOnViewOption {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0141";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0141_VerifyAdminApplicationDisplaysTheServiceProvidersDetailsInNonEditableOrViewModeWhenUserClicksOnViewOption(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.serviceManagementProvidersListPage.verifyViewModeAfterClickOnViewFromActionList();
