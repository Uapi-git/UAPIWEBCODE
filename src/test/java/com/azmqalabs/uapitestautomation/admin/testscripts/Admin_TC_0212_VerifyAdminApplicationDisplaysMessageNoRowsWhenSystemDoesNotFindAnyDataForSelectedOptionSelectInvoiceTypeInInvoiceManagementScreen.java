/**
*
* Test Script Name                      : Admin_TC_0212_VerifyAdminApplicationDisplaysMessageNoRowsWhenSystemDoesNotFindAnyDataForSelectedOptionSelectInvoiceTypeInInvoiceManagementScreen
* TestDataSheet                         : Admin_TC_0212
* Objective                             : Verify whether UAPI Admin Application displays message as 'No Rows' when system does not find any data suitable for the selected option in  'Select Invoice Type' search option.
* Version                               : 1.0
...
public class Admin_TC_0212_VerifyAdminApplicationDisplaysMessageNoRowsWhenSystemDoesNotFindAnyDataForSelectedOptionSelectInvoiceTypeInInvoiceManagementScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0212";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0212_VerifyAdminApplicationDisplaysMessageNoRowsWhenSystemDoesNotFindAnyDataForSelectedOptionSelectInvoiceTypeInInvoiceManagementScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.invoiceManagementPage.enterInvoiceTypeNotDisplayedInInvoiceManagementGridType(testdatamap,Log);
