/**
 * Test Script Name                      : Admin_TC_0117_VerifyWhetherUAPIAdminApplicationClosesTheScreenAndRedirectsToServiceBundlesScreenWhenUserClicksOnCancelButton
 * Test data sheet Name                  : Admin_TC_0117
 * Objective                             : Verify whether UAPI Admin Application closes the screen and redirects to 'Service Bundles' screen when user clicks on 'Cancel' Button.
 * Version                               : 1.0
...
public class Admin_TC_0117_VerifyWhetherUAPIAdminApplicationClosesTheScreenAndRedirectsToServiceBundlesScreenWhenUserClicksOnCancelButton {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0117";
    ...
    public Admin_TC_0117_VerifyWhetherUAPIAdminApplicationClosesTheScreenAndRedirectsToServiceBundlesScreenWhenUserClicksOnCancelButton(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.packageManagementPage.clickOnAddOrEditCancelButton(Log);
