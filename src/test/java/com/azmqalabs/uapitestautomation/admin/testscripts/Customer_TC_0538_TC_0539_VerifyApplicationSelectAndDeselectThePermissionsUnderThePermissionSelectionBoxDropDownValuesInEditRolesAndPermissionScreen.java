/**
*
* Test Script Name                      : Customer_TC_0538_TC_0539_VerifyApplicationSelectAndDeselectThePermissionsUnderThePermissionSelectionBoxDropDownValuesInEditRolesAndPermissionScreen
* TestDataSheet                         : Customer_TC_0538_TC_0539
* Objective                             : Verify whether application Select and deselect the permissions under the permission selection box dropdown values.
* Version                               : 1.0
...
Customer_TC_0538_TC_0539_VerifyApplicationSelectAndDeselectThePermissionsUnderThePermissionSelectionBoxDropDownValuesInEditRolesAndPermissionScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0538_TC_0539";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0538_TC_0539_VerifyApplicationSelectAndDeselectThePermissionsUnderThePermissionSelectionBoxDropDownValuesInEditRolesAndPermissionScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerRolesAndPermissionsPage.clickOnActionButton(Log);
				Pages.customerRolesAndPermissionsPage.clickOnEdit(Log);
				Pages.customerEditRolesAndPermissionsPage.verifyEditRolesAndPermissionPageIsDisplayed(Log);
				Pages.customerEditRolesAndPermissionsPage.clickEnableAllRatioButton(Log);
				Pages.customerEditRolesAndPermissionsPage.verifyAllEnabledPermissionsForCustomer(testdatamap,Log);
				Pages.customerEditRolesAndPermissionsPage.clickOnPermissionDropDown(Log);
				Pages.customerEditRolesAndPermissionsPage.selectAndDeselectPermissionsForPermissionDropdown(testdatamap,Log);
				Pages.customerEditRolesAndPermissionsPage.verifyDeletedPermissionIsNotDisplayedInSelectedPermissionBox(testdatamap,Log);
				Pages.customerEditRolesAndPermissionsPage.selectAndDeselectPermissionsForPermissionDropdown(testdatamap,Log);
				Pages.customerEditRolesAndPermissionsPage.verifySelectedPermissionIsDisplayedInSelectedPermissionBox(testdatamap,Log);
