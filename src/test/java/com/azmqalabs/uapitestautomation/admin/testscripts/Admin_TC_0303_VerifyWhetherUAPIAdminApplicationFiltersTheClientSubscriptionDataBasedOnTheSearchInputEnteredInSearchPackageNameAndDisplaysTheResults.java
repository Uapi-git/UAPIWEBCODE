/**
 *
 * Test Script Name                      : Admin_TC_0303_VerifyWhetherUAPIAdminApplicationFiltersTheClientSubscriptionDataBasedOnTheSearchInputEnteredInSearchPackageNameAndDisplaysTheResults.
 * Test data sheet Name                  : Admin_TC_0303
 * Objective                             : Verify whether UAPI Admin Application filters the Client Subscription data based on the search input entered in 'Search Package Name' and displays the results.
 * Version                               : 1.0
...
public class Admin_TC_0303_VerifyWhetherUAPIAdminApplicationFiltersTheClientSubscriptionDataBasedOnTheSearchInputEnteredInSearchPackageNameAndDisplaysTheResults {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0303";
    ...
    public Admin_TC_0303_VerifyWhetherUAPIAdminApplicationFiltersTheClientSubscriptionDataBasedOnTheSearchInputEnteredInSearchPackageNameAndDisplaysTheResults(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.searchPackageName(testdatamap,Log);
