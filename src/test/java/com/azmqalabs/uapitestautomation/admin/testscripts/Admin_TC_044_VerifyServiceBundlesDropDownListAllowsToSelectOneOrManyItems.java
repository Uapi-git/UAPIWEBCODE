/**
*
* Test Script Name                      : Admin_TC_044_VerifyServiceBundlesDropDownListAllowsToSelectOneOrManyItems
* TestDataSheet                         : Admin_TC_044
* Objective                             : Verify whether UAPI admin application displays all the active 'Service Bundles' (Dropdown list) in Setting tab under Account Creation. And user should be able to select one or more that one items from dropdown list
* Version                               : 1.0
...
public class Admin_TC_044_VerifyServiceBundlesDropDownListAllowsToSelectOneOrManyItems {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_044";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_044_VerifyServiceBundlesDropDownListAllowsToSelectOneOrManyItems(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.verifySelectServiceBundles(testdatamap);
