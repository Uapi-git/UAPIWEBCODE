/**
 * Test Script Name                      : CustPortal_TC_0395_VerifyWhetherApplicationDisplaysTheSubscribedPackageDetailsUnderAnnualSubscriptionTierTabOnlyWhenTheUserHasAlreadySubscribedThePackageAndThePackageIsInActiveStatus.
 * Test data sheet Name                  : CustPortal_TC_0395
 * Objective                             : Verify whether application displays the 'Subscribed Package' details under 'Annual Subscription Tier' tab only when the user has already subscribed the package and the package is in active status.
 * Version                               : 1.0
...
public class CustPortal_TC_0395_VerifyWhetherApplicationDisplaysTheSubscribedPackageDetailsUnderAnnualSubscriptionTierTabOnlyWhenTheUserHasAlreadySubscribedThePackageAndThePackageIsInActiveStatus {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0395";
...
public CustPortal_TC_0395_VerifyWhetherApplicationDisplaysTheSubscribedPackageDetailsUnderAnnualSubscriptionTierTabOnlyWhenTheUserHasAlreadySubscribedThePackageAndThePackageIsInActiveStatus(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerAddPackagePage.verifyAlreadySubscribedPackageDetails(testdatamap,Log);
