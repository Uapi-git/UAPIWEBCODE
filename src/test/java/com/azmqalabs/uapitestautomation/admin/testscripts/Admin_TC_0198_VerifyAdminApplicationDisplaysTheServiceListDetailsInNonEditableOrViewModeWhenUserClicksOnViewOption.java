/**
*
* Test Script Name                      : Admin_TC_0198_VerifyAdminApplicationDisplaysTheServiceListDetailsInNonEditableOrViewModeWhenUserClicksOnViewOption
* TestDataSheet                         : Admin_TC_0198
* Objective                             : Verify whether UAPI Admin Application displays the Service Heads details in non-editable or view mode when user clicks on 'View' option under Action menu.
* Version                               : 1.0
...
public class Admin_TC_0198_VerifyAdminApplicationDisplaysTheServiceListDetailsInNonEditableOrViewModeWhenUserClicksOnViewOption {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0198";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0198_VerifyAdminApplicationDisplaysTheServiceListDetailsInNonEditableOrViewModeWhenUserClicksOnViewOption(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws Exception{
	        try{
				...
				Pages.serviceManagementServicesListPage.clickOnServicesList(Log);
				Pages.serviceManagementServicesListPage.verifyServicesListPageIsDisplayed(Log);
				Pages.serviceManagementServicesListPage.verifyGridData(Log);
				Pages.serviceManagementServicesListPage.clickOnActionButton(Log);
				Pages.serviceManagementServicesListPage.clickOnView(Log);
				Pages.serviceManagementServicesListPage.verifyViewModeAfterClickOnViewFromActionList();
