/**
 * Test Script Name                      : CustPortal_TC_0416_VerifyWhetherTheApplicationAddTheAnnualSubscriptionTierPackageAmountToTransactionConsumptionEveryTimeTheUserExecutedTheServiceRegardlessSuccessfullyOrFailure.
 * Test data sheet Name                  : CustPortal_TC_0416
 * Objective                             : Verify whether the Application add the Annual Subscription Tier package  amount to 'Transaction consumption' every time the user executed the service regardless successfully or failure.
 * Version                               : 1.0
...
public class CustPortal_TC_0416_VerifyWhetherTheApplicationAddTheAnnualSubscriptionTierPackageAmountToTransactionConsumptionEveryTimeTheUserExecutedTheServiceRegardlessSuccessfullyOrFailure {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0416";
...
public CustPortal_TC_0416_VerifyWhetherTheApplicationAddTheAnnualSubscriptionTierPackageAmountToTransactionConsumptionEveryTimeTheUserExecutedTheServiceRegardlessSuccessfullyOrFailure(Map<Object, Object> testdatamap) {
