/**
 * Test Script Name                      : CustPortal_TC_0481_VerifyWhetherUAPICustomerPortalAllowsUserToDownloadInvoiceReportInPdfFormatOnClickOfExportPDFButton.
 * Test data sheet Name                  : CustPortal_TC_0481
 * Objective                             : Verify whether UAPI Customer Portal allows user to download invoice report in pdf format on click of 'Export PDF' button.
 * Version                               : 1.0
...
public class CustPortal_TC_0481_VerifyWhetherUAPICustomerPortalAllowsUserToDownloadInvoiceReportInPdfFormatOnClickOfExportPDFButton {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0481";
...
public CustPortal_TC_0481_VerifyWhetherUAPICustomerPortalAllowsUserToDownloadInvoiceReportInPdfFormatOnClickOfExportPDFButton(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerMyInvoicesPage.clickOnExportPDFButton(Log);
        Pages.reportsConsumptionDetailsPage.verifyDownloadedFileFormat("InvoiceList","pdf");
