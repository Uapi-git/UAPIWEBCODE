/**
*
* Test Script Name                      : Customer_TC_0608_VerifyServicesResponseUnderMofeedEmployeeStatisticsInGOSIOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0608
* Objective                             : Verify services response under 'Mofeed Employee statistics' in 'GOSI' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0608_VerifyServicesResponseUnderMofeedEmployeeStatisticsInGOSIOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0608";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0608_VerifyServicesResponseUnderMofeedEmployeeStatisticsInGOSIOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterMolEstID(testdatamap,Log);
				Pages.customerServicesPage.enterMolEstOfficeID(testdatamap,Log);
