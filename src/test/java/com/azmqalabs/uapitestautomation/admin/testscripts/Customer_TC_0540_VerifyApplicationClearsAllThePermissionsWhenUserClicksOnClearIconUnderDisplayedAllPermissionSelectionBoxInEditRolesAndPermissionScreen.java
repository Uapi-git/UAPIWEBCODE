/**
*
* Test Script Name                      : Customer_TC_0540_VerifyApplicationClearsAllThePermissionsWhenUserClicksOnClearIconUnderDisplayedAllPermissionSelectionBoxInEditRolesAndPermissionScreen
* TestDataSheet                         : Customer_TC_0540
* Objective                             : Verify whether application clears all the permissions when user clicks on 'X' clear icon under 'Displayed All selection box'.
* Version                               : 1.0
...
Customer_TC_0540_VerifyApplicationClearsAllThePermissionsWhenUserClicksOnClearIconUnderDisplayedAllPermissionSelectionBoxInEditRolesAndPermissionScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0540";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0540_VerifyApplicationClearsAllThePermissionsWhenUserClicksOnClearIconUnderDisplayedAllPermissionSelectionBoxInEditRolesAndPermissionScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerEditRolesAndPermissionsPage.clickOnClearButton(Log);
