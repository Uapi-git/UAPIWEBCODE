/**
*
* Test Script Name                      : Customer_TC_0568_VerifyApplicationAllowsUserToClickOnUseMyCredentialsToggleToEnableDisableTheOptionInConnectivityTab
* TestDataSheet                         : Customer_TC_0568
* Objective                             : Verify whether application allows user to click on 'Use my credentials' toggle to Enable/Disable the option
* Version                               : 1.0
...
Customer_TC_0568_VerifyApplicationAllowsUserToClickOnUseMyCredentialsToggleToEnableDisableTheOptionInConnectivityTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0568";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0568_VerifyApplicationAllowsUserToClickOnUseMyCredentialsToggleToEnableDisableTheOptionInConnectivityTab(Map<Object, Object> testdatamap){
