/**
*
* Test Script Name                      : Customer_TC_0626_VerifyServicesResponseUnderEmitadDetailedSalaryCertificatesInNCGROriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0626
* Objective                             : Verify services response under 'Emitad Detailed Salary Certificates' in 'NCGR' Original Service Provider.
* Version                               : 1.0
...
public class Customer_TC_0626_VerifyServicesResponseUnderEmitadDetailedSalaryCertificatesInNCGROriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0626";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0626_VerifyServicesResponseUnderEmitadDetailedSalaryCertificatesInNCGROriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterPersonalIdNumber(testdatamap,Log);
				Pages.customerServicesPage.enterBirthDate(testdatamap,Log);
				Pages.customerServicesPage.selectIdType(testdatamap,Log);
				Pages.customerServicesPage.selectCards(testdatamap,Log);
				Pages.customerServicesPage.enterPayMonth(testdatamap,Log);
				Pages.customerServicesPage.selectDateType(testdatamap,Log);
