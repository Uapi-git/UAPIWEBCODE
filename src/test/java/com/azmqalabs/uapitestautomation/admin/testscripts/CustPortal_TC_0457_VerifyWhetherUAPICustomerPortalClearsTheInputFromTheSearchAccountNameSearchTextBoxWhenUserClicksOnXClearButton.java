/**
 * Test Script Name                      : CustPortal_TC_0457_VerifyWhetherUAPICustomerPortalClearsTheInputFromTheSearchAccountNameSearchTextBoxWhenUserClicksOnXClearButton.
 * Test data sheet Name                  : CustPortal_TC_0457
 * Objective                             : Verify whether UAPI Customer Portal clears the input from the 'Search Account Name' search text box, when user clicks on 'X' clear button.
 * Version                               : 1.0
...
public class CustPortal_TC_0457_VerifyWhetherUAPICustomerPortalClearsTheInputFromTheSearchAccountNameSearchTextBoxWhenUserClicksOnXClearButton {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0457";
...
public CustPortal_TC_0457_VerifyWhetherUAPICustomerPortalClearsTheInputFromTheSearchAccountNameSearchTextBoxWhenUserClicksOnXClearButton(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerMyInvoicesPage.clickOnSearchFieldClearBtn(Log);
        Pages.customerMyInvoicesPage.VerifyClearedValueOfPackageNameSearchField(Log);
