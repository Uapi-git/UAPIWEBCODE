/**
*
* Test Script Name                      : Customer_TC_0579_VerifyServicesResponseUnderTCCAddressByIDInSDAIAOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0579
* Objective                             : Verify services response under 'TCC-Address by ID' in 'SDAIA' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0579_VerifyServicesResponseUnderTCCAddressByIDInSDAIAOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0579";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0579_VerifyServicesResponseUnderTCCAddressByIDInSDAIAOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.verifyListOfServicesForServiceHeadAddressById(Log);
