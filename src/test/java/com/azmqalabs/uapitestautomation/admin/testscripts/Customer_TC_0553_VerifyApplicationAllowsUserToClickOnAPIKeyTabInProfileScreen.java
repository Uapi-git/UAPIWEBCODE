/**
*
* Test Script Name                      : Customer_TC_0553_VerifyApplicationAllowsUserToClickOnAPIKeyTabInProfileScreen
* TestDataSheet                         : Customer_TC_0553
* Objective                             : Verify whether Application allows user to click on 'API Key' tab in Profile screen
* Version                               : 1.0
...
public class Customer_TC_0553_VerifyApplicationAllowsUserToClickOnAPIKeyTabInProfileScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0553";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0553_VerifyApplicationAllowsUserToClickOnAPIKeyTabInProfileScreen(Map<Object, Object> testdatamap){
