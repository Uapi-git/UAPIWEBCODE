/**
*
* Test Script Name                      : Admin_TC_042_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDataInSettingsTab
* TestDataSheet                         : Admin_TC_042
* Objective                             : Verify whether UAPI Admin application displays valid error message on incorrect details or blank data in mandatory field in 'Settings' tab
* Version                               : 1.0
...
public class Admin_TC_042_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDataInSettingsTab {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_042";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_042_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDataInSettingsTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.verifySettingsTabErrorMessage(testdatamap,Log);
