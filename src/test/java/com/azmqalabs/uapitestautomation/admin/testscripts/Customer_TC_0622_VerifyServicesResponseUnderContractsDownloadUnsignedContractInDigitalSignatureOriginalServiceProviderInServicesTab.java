/**
*
* Test Script Name                      : Customer_TC_0622_VerifyServicesResponseUnderContractsDownloadUnsignedContractInDigitalSignatureOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0622
* Objective                             : Verify services response under 'Contracts download unsigned contract in Digital Signature Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0622_VerifyServicesResponseUnderContractsDownloadUnsignedContractInDigitalSignatureOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0622";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0622_VerifyServicesResponseUnderContractsDownloadUnsignedContractInDigitalSignatureOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterContractNumber(testdatamap,Log);
