/**
 * Test Script Name                      : Admin_TC_081_TC_085_VerifyWhetherUAPIAdminApplicationSaveTheRecordAndRedirectsToAnnualSubscriptionTierScreenWhenUserClicksOnSaveButtonIfDataIsValidUAPIAdminApplicationShouldDisplayTheNewlyCreatedPackageUnderAnnualSubscriptionTierScreen.
 * Test data sheet Name                  : Admin_TC_081_TC_085
 * Objective                             : 1.Verify whether UAPI Admin Application allows user to click on 'Add Package' button on the Annual Subscription Tiers screen. 2.Verify whether UAPI Admin Application Save the record and redirects to 'Annual Subscription Tier' screen when user clicks on 'Save' Button. (if data is valid)UAPI Admin Application should display the newly created package under 'Annual Subscription Tier' screen
 * Version                               : 1.0
...
public class Admin_TC_081_TC_085_VerifyWhetherUAPIAdminApplicationSaveTheRecordAndRedirectsToAnnualSubscriptionTierScreenWhenUserClicksOnSaveButtonIfDataIsValidUAPIAdminApplicationShouldDisplayTheNewlyCreatedPackageUnderAnnualSubscriptionTierScreen {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_081_TC_085";
    ...
    public Admin_TC_081_TC_085_VerifyWhetherUAPIAdminApplicationSaveTheRecordAndRedirectsToAnnualSubscriptionTierScreenWhenUserClicksOnSaveButtonIfDataIsValidUAPIAdminApplicationShouldDisplayTheNewlyCreatedPackageUnderAnnualSubscriptionTierScreen(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.addPackagePage.addNewPackageDetails(testdatamap);
