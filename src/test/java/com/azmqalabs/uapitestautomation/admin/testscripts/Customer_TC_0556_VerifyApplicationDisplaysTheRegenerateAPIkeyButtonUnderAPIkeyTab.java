/**
*
* Test Script Name                      : Customer_TC_0556_VerifyApplicationDisplaysTheRegenerateAPIkeyButtonUnderAPIkeyTab
* TestDataSheet                         : Customer_TC_0556
* Objective                             : Verify whether application displays the 'Regenerate API key' button under API key tab
* Version                               : 1.0
...
public class Customer_TC_0556_VerifyApplicationDisplaysTheRegenerateAPIkeyButtonUnderAPIkeyTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0556";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0556_VerifyApplicationDisplaysTheRegenerateAPIkeyButtonUnderAPIkeyTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerProfilePage.verifyRegenerateApiKeyButton(Log);
