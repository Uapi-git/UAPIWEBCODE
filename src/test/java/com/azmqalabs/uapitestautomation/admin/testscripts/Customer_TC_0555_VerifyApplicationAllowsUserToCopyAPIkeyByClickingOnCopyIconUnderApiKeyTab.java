/**
*
* Test Script Name                      : Customer_TC_0555_VerifyApplicationAllowsUserToCopyAPIkeyByClickingOnCopyIconUnderApiKeyTab
* TestDataSheet                         : Customer_TC_0555
* Objective                             : Verify whether application allows user to  copy API key by clicking on 'copy' icon available beside api key.
* Version                               : 1.0
...
public class Customer_TC_0555_VerifyApplicationAllowsUserToCopyAPIkeyByClickingOnCopyIconUnderApiKeyTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0555";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0555_VerifyApplicationAllowsUserToCopyAPIkeyByClickingOnCopyIconUnderApiKeyTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerProfilePage.clickOnApiKeyCopyIcon();
				Pages.customerProfilePage.verifyApiKeyCopiedSuccessfulToastMessage(Log);
