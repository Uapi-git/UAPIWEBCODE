/**
*
* Test Script Name                      : Customer_TC_0566_VerifyApplicationAllowsUserToViewTheConnectivityTypeByClickingOnViewIconInConnectivityTab
* TestDataSheet                         : Customer_TC_0566
* Objective                             : Verify whether application allows user to view the 'connectivity type' by clicking on 'view' icon
* Version                               : 1.0
...
Customer_TC_0566_VerifyApplicationAllowsUserToViewTheConnectivityTypeByClickingOnViewIconInConnectivityTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0566";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0566_VerifyApplicationAllowsUserToViewTheConnectivityTypeByClickingOnViewIconInConnectivityTab(Map<Object, Object> testdatamap){
