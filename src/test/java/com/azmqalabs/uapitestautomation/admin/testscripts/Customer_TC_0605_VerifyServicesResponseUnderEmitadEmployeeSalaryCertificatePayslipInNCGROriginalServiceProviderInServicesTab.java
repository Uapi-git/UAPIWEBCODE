/**
*
* Test Script Name                      : Customer_TC_0605_VerifyServicesResponseUnderEmitadEmployeeSalaryCertificatePayslipInNCGROriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0605
* Objective                             : Verify services response under 'Emitad Employee Salary Certificate Payslip' in 'NCGR' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0605_VerifyServicesResponseUnderEmitadEmployeeSalaryCertificatePayslipInNCGROriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0605";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0605_VerifyServicesResponseUnderEmitadEmployeeSalaryCertificatePayslipInNCGROriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterNationalNumber(testdatamap,Log);
