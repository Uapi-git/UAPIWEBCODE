/**
 * Test Script Name                      : CustPortal_TC_0432_VerifyWhetherTheApplicationDoNotRetrieveActiveAnnualPackagesInAvailablePrepaidBundlesSectionIfThereIsNoActiveServiceBundlePackageAddInAtAccount.
 * Test data sheet Name                  : CustPortal_TC_0432
 * Objective                             : Verify whether the Application do not retrieve active annual packages in 'Available Prepaid Bundles' section  if there is no active service bundle package add in at Account.
 * Version                               : 1.0
...
public class CustPortal_TC_0432_VerifyWhetherTheApplicationDoNotRetrieveActiveAnnualPackagesInAvailablePrepaidBundlesSectionIfThereIsNoActiveServiceBundlePackageAddInAtAccount {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0432";
...
public CustPortal_TC_0432_VerifyWhetherTheApplicationDoNotRetrieveActiveAnnualPackagesInAvailablePrepaidBundlesSectionIfThereIsNoActiveServiceBundlePackageAddInAtAccount(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerPackageManagementPage.verifyActiveAnnualPackageShouldNotPresentInServiceBundle(testdatamap,Log);
