/**
*
* Test Script Name                      : Admin_TC_0229_VerifyAdminApplicationAllowsUserToDownloadInvoiceReportInPdfFormat
* TestDataSheet                         : Admin_TC_0229
...
public class Admin_TC_0229_VerifyAdminApplicationAllowsUserToDownloadInvoiceReportInPdfFormat {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0229";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0229_VerifyAdminApplicationAllowsUserToDownloadInvoiceReportInPdfFormat(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.invoiceManagementPage.clickOnExportToPdf(Log);
				Pages.invoiceManagementPage.verifyDownloadedFileFormat("InvoiceList_All_Accounts","pdf");
