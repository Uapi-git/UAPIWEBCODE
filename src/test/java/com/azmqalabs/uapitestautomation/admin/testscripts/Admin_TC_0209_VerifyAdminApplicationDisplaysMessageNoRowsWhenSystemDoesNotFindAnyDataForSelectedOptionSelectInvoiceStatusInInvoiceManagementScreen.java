/**
*
* Test Script Name                      : Admin_TC_0209_VerifyAdminApplicationDisplaysMessageNoRowsWhenSystemDoesNotFindAnyDataForSelectedOptionSelectInvoiceStatusInInvoiceManagementScreen
* TestDataSheet                         : Admin_TC_0209
* Objective                             : Verify whether UAPI Admin Application displays message as 'No Rows' when system does not find any data suitable for the selected option in  'Select Invoice Status' search option.
* Version                               : 1.0
...
public class Admin_TC_0209_VerifyAdminApplicationDisplaysMessageNoRowsWhenSystemDoesNotFindAnyDataForSelectedOptionSelectInvoiceStatusInInvoiceManagementScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0209";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0209_VerifyAdminApplicationDisplaysMessageNoRowsWhenSystemDoesNotFindAnyDataForSelectedOptionSelectInvoiceStatusInInvoiceManagementScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Log.ReportEvent("PASS", className + " - Execution Started");
	           	...
	           	Pages.invoiceManagementPage.clickOnInvoiceManagementButton(Log);
				Pages.invoiceManagementPage.enterInvoiceStatusNotDisplayedInInvoiceManagementGridStatus(testdatamap,Log);
