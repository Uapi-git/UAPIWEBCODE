/**
 *
 * Test Script Name                      : Admin_TC_054_VerifyWhetherUAPIAdminApplicationDisplaysBelowSubMenuOnClickOfPackagesManagementMenuAnnualSubscriptionTiersServiceBundles
 * Test data sheet Name                  : Admin_TC_054
 * Objective                             : Verify whether UAPI Admin Application displays below sub menu on click of Packages management menu.Annual Subscription Tiers,Service Bundles.
 * Version                               : 1.0
...
public class Admin_TC_054_VerifyWhetherUAPIAdminApplicationDisplaysBelowSubMenuOnClickOfPackagesManagementMenuAnnualSubscriptionTiersServiceBundles {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_054";
    ...
    public Admin_TC_054_VerifyWhetherUAPIAdminApplicationDisplaysBelowSubMenuOnClickOfPackagesManagementMenuAnnualSubscriptionTiersServiceBundles(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.packageManagementPage.verifyAnnualSubscriptionTiersAndServiceBundlesMenu(Log);
