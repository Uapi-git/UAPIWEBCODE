/**
 *
 * Test Script Name                      : Admin_TC_0278_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadInvoiceReportInExcelFormatOnClickOfExportExcelButton.
 * Test data sheet Name                  : Admin_TC_0278
 * Objective                             : Verify whether UAPI Admin Application allows user to download invoice report in excel format on click of 'Export Excel' button.
 * Version                               : 1.0
...
public class Admin_TC_0278_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadInvoiceReportInExcelFormatOnClickOfExportExcelButton {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0278";
    ...
    public Admin_TC_0278_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadInvoiceReportInExcelFormatOnClickOfExportExcelButton(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.clickOnExportExcelButton(Log);
            Pages.reportsPage.verifyDownloadedFileFormat("ConsumptionReport_All_Accounts","xlsx");
