/**
*
* Test Script Name                      : Customer_TC_0541_VerifyOnClickOfSaveButtonApplicationValidatesAllTheDataUnderEditRoleScreenAndIfThereIsAnyErrorThenApplicationDisplaysAnErrorMessage
* TestDataSheet                         : Customer_TC_0541
* Objective                             : Verify whether, on click of 'Save' button, Application validates all the data under Edit Role screen and if there is any error, then Application  should displays an error message.
* Version                               : 1.0
...
Customer_TC_0541_VerifyOnClickOfSaveButtonApplicationValidatesAllTheDataUnderEditRoleScreenAndIfThereIsAnyErrorThenApplicationDisplaysAnErrorMessage {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0541";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0541_VerifyOnClickOfSaveButtonApplicationValidatesAllTheDataUnderEditRoleScreenAndIfThereIsAnyErrorThenApplicationDisplaysAnErrorMessage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerEditRolesAndPermissionsPage.clickOnSave(Log);
				Pages.customerEditRolesAndPermissionsPage.verifyRoleNameErrorMessage(Log);
