/**
*
* Test Script Name                      : Customer_TC_0532_VerifyApplicationDisplaysUserDetailsInViewModeWhenUserClicksOnViewOptionUnderActionMenuInRolesAndPermissionsScreen
* TestDataSheet                         : Customer_TC_0532
* Objective                             : Verify whether Application displays below User details in View mode when user clicks on 'View' option under Action menu.
* Version                               : 1.0
...
Customer_TC_0532_VerifyApplicationDisplaysUserDetailsInViewModeWhenUserClicksOnViewOptionUnderActionMenuInRolesAndPermissionsScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0532";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0532_VerifyApplicationDisplaysUserDetailsInViewModeWhenUserClicksOnViewOptionUnderActionMenuInRolesAndPermissionsScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerRolesAndPermissionsPage.clickOnView(Log);
				Pages.customerRolesAndPermissionsPage.verifyViewModeAfterClickOnViewFromActionList();
