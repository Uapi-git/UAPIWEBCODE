/**
*
* Test Script Name                      : Customer_TC_0602_VerifyServicesResponseUnderYakeenNonSaudiByVisaInElmOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0602
* Objective                             : Verify services response under 'Yakeen Non Saudi by Visa' in 'Elm' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0602_VerifyServicesResponseUnderYakeenNonSaudiByVisaInElmOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0602";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0602_VerifyServicesResponseUnderYakeenNonSaudiByVisaInElmOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterVisaNumber(testdatamap,Log);
