/**
*
* Test Script Name                      : Admin_TC_0169_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInServiceHeadsListScreen
* TestDataSheet                         : Admin_TC_0169
* Objective                             : Verify whether UAPI Admin application should allow user to select number of record to be shown on page using 'Rows per page' option
* Version                               : 1.0
...
public class Admin_TC_0169_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInServiceHeadsListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0169";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0169_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInServiceHeadsListScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.serviceManagementHeadsListPage.clickOnPegination();
				Pages.serviceManagementHeadsListPage.selectPeginationValueFive(Log);
				Pages.serviceManagementHeadsListPage.verifySelectedRowPerPageData(Log);
