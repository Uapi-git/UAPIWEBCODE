/**
*
* Test Script Name                      : Customer_TC_0571_VerifyApplicationDisplaysTheToggleOptionAsUseMyCredentialsInDisabledModeAtTheRightPaneOnClickOfServiceProvider
* TestDataSheet                         : Customer_TC_0571
* Objective                             : Verify whether application displays the toggle option as 'Use my credentials' in disabled mode at the right pane on click of Service Provider, when the Connectivity credentials is set on service provider level and Client credentials is enabled in admin portal.
* Version                               : 1.0
...
public class Customer_TC_0571_VerifyApplicationDisplaysTheToggleOptionAsUseMyCredentialsInDisabledModeAtTheRightPaneOnClickOfServiceProviderInConnectivityTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0571";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0571_VerifyApplicationDisplaysTheToggleOptionAsUseMyCredentialsInDisabledModeAtTheRightPaneOnClickOfServiceProviderInConnectivityTab(Map<Object, Object> testdatamap){
