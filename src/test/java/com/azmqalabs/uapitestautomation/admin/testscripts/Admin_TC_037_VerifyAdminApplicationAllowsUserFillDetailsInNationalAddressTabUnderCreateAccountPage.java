/**
*
* Test Script Name                      : Admin_TC_037_VerifyAdminApplicationAllowsUserFillDetailsInNationalAddressTabUnderCreateAccountPage
* TestDataSheet                         : Admin_TC_037
* Objective                             : Verify whether user should be able to fill below details in 'National Address' tab under 'Create Account' page.
* Version                               : 1.0
...
public class Admin_TC_037_VerifyAdminApplicationAllowsUserFillDetailsInNationalAddressTabUnderCreateAccountPage {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_037";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_037_VerifyAdminApplicationAllowsUserFillDetailsInNationalAddressTabUnderCreateAccountPage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.clickOnNationalAddressTab();
