/**
 * Test Script Name                      : CustPortal_TC_0482_VerifyWhetherUAPICustomerPortalAllowsUserToDownloadInvoiceReportInExcelFormatOnClickOfExportExcelButton.
 * Test data sheet Name                  : CustPortal_TC_0482
 * Objective                             : Verify whether UAPI Customer Portal allows user to download invoice report in excel format on click of 'Export Excel' button.
 * Version                               : 1.0
...
public class CustPortal_TC_0482_VerifyWhetherUAPICustomerPortalAllowsUserToDownloadInvoiceReportInExcelFormatOnClickOfExportExcelButton {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0482";
...
public CustPortal_TC_0482_VerifyWhetherUAPICustomerPortalAllowsUserToDownloadInvoiceReportInExcelFormatOnClickOfExportExcelButton(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerMyInvoicesPage.clickOnExportExcelButton(Log);
        Pages.reportsConsumptionDetailsPage.verifyDownloadedFileFormat("InvoiceList","xlsx");
