/**
*
* Test Script Name                      : Customer_TC_0578_VerifyServicesResponseUnderTCCMobileNumberVerificationInSDAIAOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0378
* Objective                             : Verify services response under 'TCC-Mobile number verification' in 'SDAIA' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0578_VerifyServicesResponseUnderTCCMobileNumberVerificationInSDAIAOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0578";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0578_VerifyServicesResponseUnderTCCMobileNumberVerificationInSDAIAOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.verifyListOfServicesForServiceHeadMobileNumberVerification(Log);
