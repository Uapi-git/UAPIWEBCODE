/**
*
* Test Script Name                      : Admin_TC_0144_VerifyAdminApplicationDisplaysAnErrorMessageWhenSelectedUploadFileIsOverOneMB
* TestDataSheet                         : Admin_TC_0144
* Objective                             : Verify whether UAPI Admin Application displays an error message as 'Error! Max file size should be 1MB' when user selects the file over 1 MB size under the Edit Service Providers screen, Upload option
* Version                               : 1.0
...
public class Admin_TC_0144_VerifyAdminApplicationDisplaysAnErrorMessageWhenSelectedUploadFileIsOverOneMBInEditServiceProviderListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0144";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0144_VerifyAdminApplicationDisplaysAnErrorMessageWhenSelectedUploadFileIsOverOneMBInEditServiceProviderListScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editServiceProviderListPage.verifyFileUploadErrorMessage(testdatamap,Log);
