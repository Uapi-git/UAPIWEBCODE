/**
 * Test Script Name                      : CustPortal_TC_0391_VerifyWhetherOnClickOnAddPackageButtonUAPICustomerPortalOpensAddPackageScreenAndDisplaysBelowTabsForUserToSelectAnnualSubscriptionTierServiceBundles.
 * Test data sheet Name                  : CustPortal_TC_0391
 * Objective                             : Verify whether, on click on 'Add Package' button, UAPI Customer Portal opens 'Add Package' screen and displays below tabs for user to select - Annual Subscription Tier,Service Bundles.
 * Version                               : 1.0
...
public class CustPortal_TC_0391_VerifyWhetherOnClickOnAddPackageButtonUAPICustomerPortalOpensAddPackageScreenAndDisplaysBelowTabsForUserToSelectAnnualSubscriptionTierServiceBundles {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0391";
...
public CustPortal_TC_0391_VerifyWhetherOnClickOnAddPackageButtonUAPICustomerPortalOpensAddPackageScreenAndDisplaysBelowTabsForUserToSelectAnnualSubscriptionTierServiceBundles(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerAddPackagePage.verifyAnnualSubscriptionTiersAndServicesBundlesTabsAreDisplayed();
