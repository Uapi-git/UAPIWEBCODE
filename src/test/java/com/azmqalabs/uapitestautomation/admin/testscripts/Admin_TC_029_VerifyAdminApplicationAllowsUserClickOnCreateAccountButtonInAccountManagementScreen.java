/**
*
* Test Script Name                      : Admin_TC_029_VerifyAdminApplicationAllowsUserClickOnCreateAccountButtonInAccountManagementScreen
* TestDataSheet                         : Admin_TC_029
* Objective                             : Verify whether UAPI Admin application allows user click on 'Create Account' button to begin with Account opening process
* Version                               : 1.0
...
public class Admin_TC_029_VerifyAdminApplicationAllowsUserClickOnCreateAccountButtonInAccountManagementScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_029";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_029_VerifyAdminApplicationAllowsUserClickOnCreateAccountButtonInAccountManagementScreen(Map<Object, Object> testdatamap){
