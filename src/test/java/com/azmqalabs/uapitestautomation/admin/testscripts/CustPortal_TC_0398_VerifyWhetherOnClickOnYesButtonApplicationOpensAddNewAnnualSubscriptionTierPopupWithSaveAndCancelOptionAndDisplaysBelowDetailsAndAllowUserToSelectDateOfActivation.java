/**
 * Test Script Name                      : CustPortal_TC_0398_VerifyWhetherOnClickOnYesButtonApplicationOpensAddNewAnnualSubscriptionTierPopupWithSaveAndCancelOptionAndDisplaysBelowDetailsAndAllowUserToSelectDateOfActivation.
 * Test data sheet Name                  : CustPortal_TC_0398
 * Objective                             : Verify whether on click on 'Yes' button - application opens 'Add New Annual Subscription Tier' popup with 'Save' and 'Cancel' option and displays below details and allow user to select Date of activation.
 * Version                               : 1.0
...
public class CustPortal_TC_0398_VerifyWhetherOnClickOnYesButtonApplicationOpensAddNewAnnualSubscriptionTierPopupWithSaveAndCancelOptionAndDisplaysBelowDetailsAndAllowUserToSelectDateOfActivation {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0398";
...
public CustPortal_TC_0398_VerifyWhetherOnClickOnYesButtonApplicationOpensAddNewAnnualSubscriptionTierPopupWithSaveAndCancelOptionAndDisplaysBelowDetailsAndAllowUserToSelectDateOfActivation(Map<Object, Object> testdatamap) {
...
//        Pages.customerAddPackagePage.clickOnAreYouSureYouWantToSelectThisPackagePopUpYesBtn(Log);
        Pages.customerAddPackagePage.verifyAddNewAnnualSubscriptionTierPopUpPackageComponents();
