/**
 *
 * Test Script Name                      : Admin_TC_0308_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnUserManagementMenuAndOnClickUAPIAdminApplicationDisplaysTheUserManagementScreenAtTheRightPane.
 * Test data sheet Name                  : Admin_TC_0308
 * Objective                             : Verify whether UAPI Admin Application allows user to click on 'User Management' menu and on click UAPI Admin Application displays the User Management screen at the Right pane.
 * Version                               : 1.0
...
public class Admin_TC_0308_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnUserManagementMenuAndOnClickUAPIAdminApplicationDisplaysTheUserManagementScreenAtTheRightPane {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0308";
    ...
    public Admin_TC_0308_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnUserManagementMenuAndOnClickUAPIAdminApplicationDisplaysTheUserManagementScreenAtTheRightPane(Map<Object, Object> testdatamap) {
