/**
 *
 * Test Script Name                      : Admin_TC_0300_VerifyWhetherUAPIAdminApplicationFiltersTheClientSubscriptionDataBasedOnTheSearchInputEnteredInSearchClientNameAndDisplaysTheResults.
 * Test data sheet Name                  : Admin_TC_0300
 * Objective                             : Verify whether UAPI Admin Application filters the Client Subscription data based on the search input entered in 'Search Client Name' and displays the results.
 * Version                               : 1.0
...
public class Admin_TC_0300_VerifyWhetherUAPIAdminApplicationFiltersTheClientSubscriptionDataBasedOnTheSearchInputEnteredInSearchClientNameAndDisplaysTheResults {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0300";
    ...
    public Admin_TC_0300_VerifyWhetherUAPIAdminApplicationFiltersTheClientSubscriptionDataBasedOnTheSearchInputEnteredInSearchClientNameAndDisplaysTheResults(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.searchClientName(testdatamap,Log);
