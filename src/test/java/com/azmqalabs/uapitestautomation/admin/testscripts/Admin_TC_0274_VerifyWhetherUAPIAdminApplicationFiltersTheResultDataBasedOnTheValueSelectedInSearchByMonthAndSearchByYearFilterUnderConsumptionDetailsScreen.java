/**
 *
 * Test Script Name                      : Admin_TC_0274_VerifyWhetherUAPIAdminApplicationFiltersTheResultDataBasedOnTheValueSelectedInSearchByMonthAndSearchByYearFilterUnderConsumptionDetailsScreen.
 * Test data sheet Name                  : Admin_TC_0274
 * Objective                             : Verify whether UAPI Admin Application filters the result data based on the value selected in 'Search by Month' and  'Search by Year' filter under Consumption Details screen.
 * Version                               : 1.0
...
public class Admin_TC_0274_VerifyWhetherUAPIAdminApplicationFiltersTheResultDataBasedOnTheValueSelectedInSearchByMonthAndSearchByYearFilterUnderConsumptionDetailsScreen {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0274";
    ...
    public Admin_TC_0274_VerifyWhetherUAPIAdminApplicationFiltersTheResultDataBasedOnTheValueSelectedInSearchByMonthAndSearchByYearFilterUnderConsumptionDetailsScreen(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.selectSearchByMonthValue(testdatamap,Log);
            Pages.reportsPage.selectSearchByYearValue(testdatamap,Log);
            Pages.reportsPage.verifyGridDataSortedBasedOnSelectedValue(testdatamap,Log);
