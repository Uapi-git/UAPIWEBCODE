/**
 *
 * Test Script Name                      : Admin_TC_0306_VerifyWhetherUAPIAdminApplicationFiltersTheClientSubscriptionDataBasedOnTheSearchOptionSelectionInSelectPackageStatusFilterAndDisplaysTheResults.
 * Test data sheet Name                  : Admin_TC_0306
 * Objective                             : Verify whether UAPI Admin Application filters the Client Subscription data based on the search option selection in 'Select Package Status' filter and displays the results.
 * Version                               : 1.0
...
public class Admin_TC_0306_VerifyWhetherUAPIAdminApplicationFiltersTheClientSubscriptionDataBasedOnTheSearchOptionSelectionInSelectPackageStatusFilterAndDisplaysTheResults {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0306";
    ...
    public Admin_TC_0306_VerifyWhetherUAPIAdminApplicationFiltersTheClientSubscriptionDataBasedOnTheSearchOptionSelectionInSelectPackageStatusFilterAndDisplaysTheResults(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.searchWithSelectPackageStatus(testdatamap,Log);
            Pages.reportsPage.parseReportsClientSubscriptionsGridData("Grid Data");
            Pages.reportsPage.verifyClientSubscriptionGridRecordData(1,testdatamap,Log);
