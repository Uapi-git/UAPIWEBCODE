/**
*
* Test Script Name                      : Admin_TC_0149_VerifyWhenClientCredentialsToggleIsENABLEDUnderEditServiceProvidersScreenThenServiceSelectedProviderShouldBeDisplayedInCustomerPortalsConnectivityMenu
* TestDataSheet                         : Admin_TC_0149
* Objective                             : Verify whether when 'Client Credentials' toggle is ENABLED under Edit Service Providers screen then the Service selected provider should be displayed in the UAPI customer portals 'Connectivity' menu with the list of Service Heads.
* Version                               : 1.0
...
public class Admin_TC_0149_VerifyWhenClientCredentialsToggleIsENABLEDUnderEditServiceProvidersScreenThenServiceSelectedProviderShouldBeDisplayedInCustomerPortalsConnectivityMenu {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0149";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0149_VerifyWhenClientCredentialsToggleIsENABLEDUnderEditServiceProvidersScreenThenServiceSelectedProviderShouldBeDisplayedInCustomerPortalsConnectivityMenu(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerProfilePage.verifySimhaServiceProviderNameIsDisplayed(Log);
