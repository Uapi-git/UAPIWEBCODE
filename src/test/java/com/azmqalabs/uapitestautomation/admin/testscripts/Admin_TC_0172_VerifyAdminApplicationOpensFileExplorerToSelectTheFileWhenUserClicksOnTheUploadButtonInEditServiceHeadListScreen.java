/**
*
* Test Script Name                      : Admin_TC_0172_VerifyAdminApplicationOpensFileExplorerToSelectTheFileWhenUserClicksOnTheUploadButtonInEditServiceHeadListScreen
* TestDataSheet                         : Admin_TC_0172
* Objective                             : Verify whether UAPI Admin Application opens a file explorer to select the file when user clicks on the 'Upload' button under the Edit Service Heads screen
* Version                               : 1.0
...
public class Admin_TC_0172_VerifyAdminApplicationOpensFileExplorerToSelectTheFileWhenUserClicksOnTheUploadButtonInEditServiceHeadListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0172";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0172_VerifyAdminApplicationOpensFileExplorerToSelectTheFileWhenUserClicksOnTheUploadButtonInEditServiceHeadListScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editServiceManagementHeadsListPage.uploadFile(Log);
				Pages.editServiceManagementHeadsListPage.verifyFileUploadedSuccessfully(testdatamap);
