/**
*
* Test Script Name                      : Customer_TC_0620_VerifyServicesResponseUnderContractsUploadContractWithSanadInDigitalSignatureOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0620
* Objective                             : Verify services response under 'Contracts Upload Contract with sanad in Digital Signature Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0620_VerifyServicesResponseUnderContractsUploadContractWithSanadInDigitalSignatureOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0620";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0620_VerifyServicesResponseUnderContractsUploadContractWithSanadInDigitalSignatureOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterXContractsTimeStamp(testdatamap,Log);
				Pages.customerServicesPage.enterXContractsSignature(testdatamap,Log);
				Pages.customerServicesPage.enterXSignature(testdatamap,Log);
