/**
 *
 * Test Script Name                      : Admin_TC_0279_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnClientSubscriptionsSubmenuAndOnClickUAPIAdminApplicationDisplaysTheClientSubscriptionsScreenAtTheRightPane.
 * Test data sheet Name                  : Admin_TC_0279
 * Objective                             : Verify whether UAPI Admin Application allows user to click on 'Client Subscriptions' submenu and on click UAPI Admin Application displays the Client Subscriptions screen at the Right pane.
 * Version                               : 1.0
...
public class Admin_TC_0279_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnClientSubscriptionsSubmenuAndOnClickUAPIAdminApplicationDisplaysTheClientSubscriptionsScreenAtTheRightPane {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0279";
    ...
    public Admin_TC_0279_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnClientSubscriptionsSubmenuAndOnClickUAPIAdminApplicationDisplaysTheClientSubscriptionsScreenAtTheRightPane(Map<Object, Object> testdatamap) {
