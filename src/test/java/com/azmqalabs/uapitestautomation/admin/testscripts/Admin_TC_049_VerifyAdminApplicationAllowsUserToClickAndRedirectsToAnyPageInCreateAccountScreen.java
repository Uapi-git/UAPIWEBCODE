/**
*
* Test Script Name                      : Admin_TC_049_VerifyAdminApplicationAllowsUserToClickAndRedirectsToAnyPageInCreateAccountscreen
* TestDataSheet                         : Admin_TC_049
* Objective                             : Verify whether UAPI admin application allows user to click and redirects to any below form page under 'Create Account' screen at any time.
* Version                               : 1.0
...
public class Admin_TC_049_VerifyAdminApplicationAllowsUserToClickAndRedirectsToAnyPageInCreateAccountScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_049";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_049_VerifyAdminApplicationAllowsUserToClickAndRedirectsToAnyPageInCreateAccountScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.verifyUserCanRedirectsToAnyTabInCreateAccountManagementScreen(testdatamap,Log);
