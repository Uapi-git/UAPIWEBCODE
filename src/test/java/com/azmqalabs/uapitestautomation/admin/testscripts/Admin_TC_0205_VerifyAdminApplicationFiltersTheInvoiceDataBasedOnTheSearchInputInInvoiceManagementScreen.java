/**
*
* Test Script Name                      : Admin_TC_0205_VerifyAdminApplicationFiltersTheInvoiceDataBasedOnTheSearchInputInInvoiceManagementScreen
* TestDataSheet                         : Admin_TC_0205
* Objective                             : Verify whether UAPI Admin Application filters the Invoice data based on the search input entered in 'Search Account Name' and displays the results
* Version                               : 1.0
...
public class Admin_TC_0205_VerifyAdminApplicationFiltersTheInvoiceDataBasedOnTheSearchInputInInvoiceManagementScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0205";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0205_VerifyAdminApplicationFiltersTheInvoiceDataBasedOnTheSearchInputInInvoiceManagementScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.invoiceManagementPage.enterCorrectAccountNameInSearchAccountNameSearchOption(testdatamap,Log);
