/**
*
* Test Script Name                      : Admin_TC_046_VerifyAdminApplicationDisplaysAllActiveServiceInSettingTabAndUserAbleToSelectAndDeSelectServices
* TestDataSheet                         : Admin_TC_046
* Objective                             : Verify whether UAPI admin application displays all the active 'Service' in Setting tab under Account Creation. And user should be able to select one or more Services and Deselect
* Version                               : 1.0
...
public class Admin_TC_046_VerifyAdminApplicationDisplaysAllActiveServiceInSettingTabAndUserAbleToSelectAndDeSelectServices {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_046";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_046_VerifyAdminApplicationDisplaysAllActiveServiceInSettingTabAndUserAbleToSelectAndDeSelectServices(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.verifyAllActiveServicesInSettingsTab(Log);
				...
				Pages.createAccountManagementPage.DeselectServicesFromAllServices(testdatamap);
				Pages.createAccountManagementPage.removeSelectedServices(Log);
				Pages.createAccountManagementPage.verifyDeSelectedServicesAreNotDisplayed(testdatamap);
