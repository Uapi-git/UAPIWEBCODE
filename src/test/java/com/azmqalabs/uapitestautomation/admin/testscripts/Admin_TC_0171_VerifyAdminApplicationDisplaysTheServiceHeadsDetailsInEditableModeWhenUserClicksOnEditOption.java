/**
*
* Test Script Name                      : Admin_TC_0171_VerifyAdminApplicationDisplaysTheServiceHeadsDetailsInEditableModeWhenUserClicksOnEditOption
* TestDataSheet                         : Admin_TC_0171
* Objective                             : Verify whether UAPI Admin Application displays the Service Heads details in editable mode when user clicks on 'Edit' option under Action menu.
* Version                               : 1.0
...
public class Admin_TC_0171_VerifyAdminApplicationDisplaysTheServiceHeadsDetailsInEditableModeWhenUserClicksOnEditOption {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0171";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0171_VerifyAdminApplicationDisplaysTheServiceHeadsDetailsInEditableModeWhenUserClicksOnEditOption(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editServiceManagementHeadsListPage.verifyEditableFieldsInEditServiceHeadListScreen(testdatamap,Log);
