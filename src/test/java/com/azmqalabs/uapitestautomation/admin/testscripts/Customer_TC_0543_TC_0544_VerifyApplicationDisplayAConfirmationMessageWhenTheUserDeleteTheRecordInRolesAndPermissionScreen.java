/**
*
* Test Script Name                      : Customer_TC_0543_TC_0544_VerifyApplicationDisplayAConfirmationMessageWhenTheUserDeleteTheRecordInRolesAndPermissionScreen
* TestDataSheet                         : Customer_TC_0543_TC_0544
* Objective                             : Verify whether Application display a confirmation message when the user delete the record.
* Version                               : 1.0
...
Customer_TC_0543_TC_0544_VerifyApplicationDisplayAConfirmationMessageWhenTheUserDeleteTheRecordInRolesAndPermissionScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0543_TC_0544";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0543_TC_0544_VerifyApplicationDisplayAConfirmationMessageWhenTheUserDeleteTheRecordInRolesAndPermissionScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerRolesAndPermissionsPage.clickOnDelete(Log);
				Pages.customerRolesAndPermissionsPage.verifyDeleteConformationPopup();
				Pages.customerRolesAndPermissionsPage.clickOnYesInDeleteConformationPopup();
				Pages.customerRolesAndPermissionsPage.verifyRoleDeleteSuccessfullyConformationMessage(testdatamap,Log);
				Pages.customerRolesAndPermissionsPage.clickOnClearButton();
				Pages.customerRolesAndPermissionsPage.searchRole(testdatamap,Log);
				Pages.customerRolesAndPermissionsPage.verifyRoleDeletedSuccessfully();
