/**
*
* Test Script Name                      : Customer_TC_0600_VerifyServicesResponseUnderNationalAddressInfoInSPLOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0600
* Objective                             : Verify services response under 'National Address Info' in 'SPL' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0600_VerifyServicesResponseUnderNationalAddressInfoInSPLOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0600";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0600_VerifyServicesResponseUnderNationalAddressInfoInSPLOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.verifyListOfServicesForServiceHeadNationalAddress(Log);
