/**
*
* Test Script Name                      : Customer_TC_0582_VerifyServicesResponseUnderRealEstatesDeedsInMinistryOfJusticeOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0582
* Objective                             : Verify services response under 'Real Estates Deeds' in 'Ministry of Justice' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0582_VerifyServicesResponseUnderRealEstatesDeedsInMinistryOfJusticeOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0582";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0582_VerifyServicesResponseUnderRealEstatesDeedsInMinistryOfJusticeOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterDeedNumber(testdatamap,Log);
				Pages.customerServicesPage.enterIdNumber(testdatamap,Log);
