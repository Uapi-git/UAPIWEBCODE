/**
*
* Test Script Name                      : Customer_TC_0589_VerifyServicesResponseUnderCommercialRegistrationOwnsByCountryCodeInMinistryOfCommerceOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0589
* Objective                             : Verify services response under 'Commercial Registration Owns By Country Code' in 'Ministry of Commerce' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0589_VerifyServicesResponseUnderCommercialRegistrationOwnsByCountryCodeInMinistryOfCommerceOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0589";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0589_VerifyServicesResponseUnderCommercialRegistrationOwnsByCountryCodeInMinistryOfCommerceOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterCountryCode(testdatamap,Log);
