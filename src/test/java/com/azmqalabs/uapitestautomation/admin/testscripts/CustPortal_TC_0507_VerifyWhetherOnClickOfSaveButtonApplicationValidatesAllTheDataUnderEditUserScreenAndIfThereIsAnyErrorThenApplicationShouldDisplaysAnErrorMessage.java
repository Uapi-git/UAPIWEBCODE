/**
 * Test Script Name                      : CustPortal_TC_0507_VerifyWhetherOnClickOfSaveButtonApplicationValidatesAllTheDataUnderEditUserScreenAndIfThereIsAnyErrorThenApplicationShouldDisplaysAnErrorMessage.
 * Test data sheet Name                  : Admin_TC_0507
 * Objective                             : Verify whether, on click of 'Save' button, Application validates all the data under Edit User screen and if there is any error, then Application  should displays an error message.
 * Version                               : 1.0
...
public class CustPortal_TC_0507_VerifyWhetherOnClickOfSaveButtonApplicationValidatesAllTheDataUnderEditUserScreenAndIfThereIsAnyErrorThenApplicationShouldDisplaysAnErrorMessage {
    // DECLARATION SECTION
    static String TestDataTab = "CustPortal_TC_0507";
    ...
    public CustPortal_TC_0507_VerifyWhetherOnClickOfSaveButtonApplicationValidatesAllTheDataUnderEditUserScreenAndIfThereIsAnyErrorThenApplicationShouldDisplaysAnErrorMessage(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.customerEditUserPage.enterInvalidDataInEditUserPageAndVerifyErrorMSG(testdatamap,Log);
