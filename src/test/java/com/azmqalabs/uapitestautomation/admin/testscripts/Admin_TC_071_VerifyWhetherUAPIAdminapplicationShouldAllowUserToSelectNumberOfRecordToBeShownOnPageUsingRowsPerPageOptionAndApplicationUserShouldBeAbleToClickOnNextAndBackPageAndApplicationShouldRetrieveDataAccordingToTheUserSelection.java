/**
 * Test Script Name                      : Admin_TC_071_VerifyWhetherUAPIAdminapplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationUserShouldBeAbleToClickOnNextAndBackPageAndApplicationShouldRetrieveDataAccordingToTheUserSelection.
 * Test data sheet Name                  : Admin_TC_071
...
public class Admin_TC_071_VerifyWhetherUAPIAdminapplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationUserShouldBeAbleToClickOnNextAndBackPageAndApplicationShouldRetrieveDataAccordingToTheUserSelection {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_071";
    ...
    public Admin_TC_071_VerifyWhetherUAPIAdminapplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationUserShouldBeAbleToClickOnNextAndBackPageAndApplicationShouldRetrieveDataAccordingToTheUserSelection(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.packageManagementPage.verifyAnnualSubscriptionTiersGridData(Log);
            Pages.packageManagementPage.selectRowsPerPage(5,Log);
            Pages.packageManagementPage.clickOnNextPageIconInTable(Log);
            Pages.packageManagementPage.clickOnPreviousPageIconInTable(Log);
            Pages.packageManagementPage.VerifyApplicationRetrievesDataSelectedRowsPerPage(5,Log);
