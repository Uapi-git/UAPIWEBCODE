/**
*
* Test Script Name                      : Admin_TC_047_VerifyAdminApplicationDisplaysAllActiveServiceProvidersInSettingTabAndUserAbleToSelectAndDeSelectServiceProviders
* TestDataSheet                         : Admin_TC_047
* Objective                             : Verify whether UAPI admin application displays all the active 'Service Provider' under 'Services Logging' option in Setting tab. And user should be able to select one or more that one items and move to Logging Enabled Service Providers section and vice versa
* Version                               : 1.0
...
public class Admin_TC_047_VerifyAdminApplicationDisplaysAllActiveServiceProvidersInSettingTabAndUserAbleToSelectAndDeSelectServiceProviders {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_047";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_047_VerifyAdminApplicationDisplaysAllActiveServiceProvidersInSettingTabAndUserAbleToSelectAndDeSelectServiceProviders(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.clickOnSettings(Log);
				...
				Pages.createAccountManagementPage.verifyAllActiveServiceProvidersInSettingsTab(testdatamap,Log);
				...
				Pages.createAccountManagementPage.deSelectServiceProviders(testdatamap);
				Pages.createAccountManagementPage.removeSelectedServiceProviders(Log);
				Pages.createAccountManagementPage.verifyDeSelectedServiceProvidersAreNotDisplayed(testdatamap);
