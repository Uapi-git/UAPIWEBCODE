/**
 * Test Script Name                      : CustPortal_TC_0371_VerifyWhetherApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableForTheSelectedOptionInSelectPackageStatusSearchOption.
 * Test data sheet Name                  : CustPortal_TC_0371
 * Objective                             : Verify whether Application displays message as 'No Rows' when system does not find any data suitable for the selected option in  'Select Package Status' search option..
 * Version                               : 1.0
...
public class CustPortal_TC_0371_VerifyWhetherApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableForTheSelectedOptionInSelectPackageStatusSearchOption {
    // DECLARATION SECTION
    static String TestDataTab = "CustPortal_TC_0371";
    ...
    public CustPortal_TC_0371_VerifyWhetherApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableForTheSelectedOptionInSelectPackageStatusSearchOption(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.customerPackageManagementPage.searchWithSelectPackageStatus(testdatamap,Log);
            Pages.customerPackageManagementPage.verifyNoRowsMessage(Log);
