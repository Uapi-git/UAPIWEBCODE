/**
 *
 * Test Script Name                      : Admin_TC_0313_TC_0315_VerifyWhetherUAPIAdminApplicationClearsTheInputFromTheSearchTextBoxWhenUserClicksOnXClearButton.
 * Test data sheet Name                  : Admin_TC_0313_TC_0315
 * Objective                             : 1.Verify whether UAPI Admin application clears the input from the search text box, when user clicks on 'X' clear button. 2. Verify UAPI Admin application  clear the retrieved data when the user click on Clear sign.
 * Version                               : 1.0
...
public class Admin_TC_0313_TC_0315_VerifyWhetherUAPIAdminApplicationClearsTheInputFromTheSearchTextBoxWhenUserClicksOnXClearButton {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0313_TC_0315";
    ...
    public Admin_TC_0313_TC_0315_VerifyWhetherUAPIAdminApplicationClearsTheInputFromTheSearchTextBoxWhenUserClicksOnXClearButton(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.userManagementPage.clickOnSearchFieldXBtn(Log);
            Pages.userManagementPage.VerifyClearedValueOfSearchField(Log);
