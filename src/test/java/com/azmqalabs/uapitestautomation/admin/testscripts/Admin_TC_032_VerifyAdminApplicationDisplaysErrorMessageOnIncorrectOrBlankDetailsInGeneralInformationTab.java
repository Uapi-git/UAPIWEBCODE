/**
*
* Test Script Name                      : Admin_TC_032_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDetailsInGeneralInformationTab
* TestDataSheet                         : Admin_TC_032
* Objective                             : Verify whether UAPI Admin application displays valid error message on incorrect details or blank data in mandatory field in 'General Information' tab
* Version                               : 1.0
...
public class Admin_TC_032_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDetailsInGeneralInformationTab {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_032";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_032_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDetailsInGeneralInformationTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.verifyErrorMessageInEnterGeneralInfoTab(testdatamap,Log);
