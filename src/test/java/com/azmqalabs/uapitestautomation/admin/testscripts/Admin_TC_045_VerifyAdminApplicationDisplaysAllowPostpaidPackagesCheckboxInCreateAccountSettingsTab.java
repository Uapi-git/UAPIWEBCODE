/**
*
* Test Script Name                      : Admin_TC_045_VerifyAdminApplicationDisplaysAllowPostpaidPackagesCheckboxInCreateAccountSettingsTab
* TestDataSheet                         : Admin_TC_045
* Objective                             : Verify whether UAPI admin application displays 'Allow Postpaid Packages' checkbox. And user should be able to select or deselect the option.
* Version                               : 1.0
...
public class Admin_TC_045_VerifyAdminApplicationDisplaysAllowPostpaidPackagesCheckboxInCreateAccountSettingsTab {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_045";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_045_VerifyAdminApplicationDisplaysAllowPostpaidPackagesCheckboxInCreateAccountSettingsTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.verifyAllowPostPayAccessDisplayed(testdatamap,Log);
				Pages.createAccountManagementPage.clickOnAllowPostPayAccess();
				Pages.createAccountManagementPage.verifyAllowPostPayAccessChecked();
				Pages.createAccountManagementPage.clickOnAllowPostPayAccess();
				Pages.createAccountManagementPage.verifyAllowPostPayAccessUnChecked();
