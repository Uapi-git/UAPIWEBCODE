/**
*
* Test Script Name                      : Admin_TC_050_TC_051_VerifyAdminApplicationDisplayErrorMessageWhenUserInsertIncorrectDataInOnePageWhileClickOnSaveInAnotherPage
* TestDataSheet                         : Admin_TC_050_TC_051
* Objective                             : Verify UAPI Admin application display error message when the user insert incorrect data in one page while click on save in another page.
* Version                               : 1.0
...
public class Admin_TC_050_TC_051_VerifyAdminApplicationDisplayErrorMessageWhenUserInsertIncorrectDataInOnePageWhileClickOnSaveInAnotherPage {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_050_TC_051";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_050_TC_051_VerifyAdminApplicationDisplayErrorMessageWhenUserInsertIncorrectDataInOnePageWhileClickOnSaveInAnotherPage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.verifyErrorMessageInCreateAccountManagementScreen(testdatamap,Log);
