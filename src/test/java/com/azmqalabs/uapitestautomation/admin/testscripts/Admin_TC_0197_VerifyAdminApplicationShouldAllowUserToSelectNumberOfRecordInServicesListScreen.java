/**
*
* Test Script Name                      : Admin_TC_0197_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInServicesListScreen
* TestDataSheet                         : Admin_TC_0197
...
public class Admin_TC_0197_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInServicesListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0197";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0197_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInServicesListScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.serviceManagementServicesListPage.clickOnPegination();
				Pages.serviceManagementServicesListPage.selectPeginationValueFive(Log);
				Pages.serviceManagementServicesListPage.verifySelectedRowPerPageData(Log);
