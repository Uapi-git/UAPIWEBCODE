/**
*
* Test Script Name                      : Admin_TC_0173_VerifyAdminApplicationDisplaysAnErrorMessageWhenSelectedUploadFileIsOverOneMBInEditServiceHeadListScreen
* TestDataSheet                         : Admin_TC_0173
* Objective                             : Verify whether UAPI Admin Application displays an error message as 'Error! Max file size should be 1MB' when user selects the file over 1 MB size under the Edit Service Head screen, Upload option
* Version                               : 1.0
...
public class Admin_TC_0173_VerifyAdminApplicationDisplaysAnErrorMessageWhenSelectedUploadFileIsOverOneMBInEditServiceHeadListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0173";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0173_VerifyAdminApplicationDisplaysAnErrorMessageWhenSelectedUploadFileIsOverOneMBInEditServiceHeadListScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editServiceManagementHeadsListPage.verifyFileUploadErrorMessage(testdatamap,Log);
