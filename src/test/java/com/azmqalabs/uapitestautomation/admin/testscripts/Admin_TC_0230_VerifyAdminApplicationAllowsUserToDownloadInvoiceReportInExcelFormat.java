/**
*
* Test Script Name                      : Admin_TC_0230_VerifyAdminApplicationAllowsUserToDownloadInvoiceReportInExcelFormat
* TestDataSheet                         : Admin_TC_0230
...
public class Admin_TC_0230_VerifyAdminApplicationAllowsUserToDownloadInvoiceReportInExcelFormat {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0230";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0230_VerifyAdminApplicationAllowsUserToDownloadInvoiceReportInExcelFormat(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.invoiceManagementPage.clickOnExportToExcel(Log);
				Pages.invoiceManagementPage.verifyDownloadedFileFormat("InvoiceList_All_Accounts","xlsx");
