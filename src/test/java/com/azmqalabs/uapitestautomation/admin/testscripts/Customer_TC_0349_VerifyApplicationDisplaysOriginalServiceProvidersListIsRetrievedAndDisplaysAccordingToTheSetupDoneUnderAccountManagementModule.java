	  ...
	  DBUtil DBUtil;
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				String expectedServiceProviderName[] = {"Simah", "Ministry Of Justice", "SDAIA", "Ministry Of Commerce", "SPL", "Elm", "NCGR","GOSI","CST","Saudi Payment","Lean","Digital Signature"};
				...
				Pages.customerServicesPage.verifyAllOriginalServiceProviderList(expectedServiceProviderName,Log);
