/**
 * Test Script Name                      : CustPortal_TC_0504_VerifyWhetherApplicationDisplaysBelowUserDetailsInViewModeWhenUserClicksOnViewOptionUnderActionMenuIDFirstNameLastNameNationalIDEmailUserNameMobileNumberRoleStatus.
 * Test data sheet Name                  : CustPortal_TC_0504
 * Objective                             : Verify whether Application displays below User details in View mode when user clicks on 'View' option under Action menu.ID,First Name,Last Name,National ID,Email,User Name,Mobile Number,Role,Status
 * Version                               : 1.0
...
public class CustPortal_TC_0504_VerifyWhetherApplicationDisplaysBelowUserDetailsInViewModeWhenUserClicksOnViewOptionUnderActionMenuIDFirstNameLastNameNationalIDEmailUserNameMobileNumberRoleStatus {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0504";
...
public CustPortal_TC_0504_VerifyWhetherApplicationDisplaysBelowUserDetailsInViewModeWhenUserClicksOnViewOptionUnderActionMenuIDFirstNameLastNameNationalIDEmailUserNameMobileNumberRoleStatus(Map<Object, Object> testdatamap) {
