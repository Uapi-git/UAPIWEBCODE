/**
*
* Test Script Name                      : Customer_TC_0547_VerifyApplicationDisplayErrorMessagesWhenClickOnSaveButtonWhileSomeFieldsAreEmptyOrIncorrectInAddRolesAndPermissionScreen
* TestDataSheet                         : Customer_TC_0547
* Objective                             : Verify whether the Application display error messages when click on 'Save' button while some fields are empty or incorrect.
* Version                               : 1.0
...
Customer_TC_0547_VerifyApplicationDisplayErrorMessagesWhenClickOnSaveButtonWhileSomeFieldsAreEmptyOrIncorrectInAddRolesAndPermissionScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0547";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0547_VerifyApplicationDisplayErrorMessagesWhenClickOnSaveButtonWhileSomeFieldsAreEmptyOrIncorrectInAddRolesAndPermissionScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerRolesAndPermissionsPage.verifyErrorMessageInAddRoleAndPermissionScreen(testdatamap,Log);
