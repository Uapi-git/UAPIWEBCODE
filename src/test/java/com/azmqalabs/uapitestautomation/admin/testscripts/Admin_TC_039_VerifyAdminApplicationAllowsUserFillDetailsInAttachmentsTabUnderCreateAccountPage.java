/**
*
* Test Script Name                      : Admin_TC_039_VerifyAdminApplicationAllowsUserFillDetailsInAttachmentsTabUnderCreateAccountPage
* TestDataSheet                         : Admin_TC_039
* Objective                             : Verify whether user should be able to fill below details in 'Attachments' tab under 'Create Account' page.
* Version                               : 1.0
...
public class Admin_TC_039_VerifyAdminApplicationAllowsUserFillDetailsInAttachmentsTabUnderCreateAccountPage {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_039";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_039_VerifyAdminApplicationAllowsUserFillDetailsInAttachmentsTabUnderCreateAccountPage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.clickOnAttachmentTab();
