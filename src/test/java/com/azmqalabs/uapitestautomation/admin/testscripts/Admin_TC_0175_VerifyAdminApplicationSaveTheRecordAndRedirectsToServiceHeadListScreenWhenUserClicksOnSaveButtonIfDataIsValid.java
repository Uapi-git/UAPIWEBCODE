/**
*
* Test Script Name                      : Admin_TC_0175_VerifyAdminApplicationSaveTheRecordAndRedirectsToServiceHeadListScreenWhenUserClicksOnSaveButtonIfDataIsValid
* TestDataSheet                         : Admin_TC_0175
* Objective                             : Verify whether UAPI Admin Application Save the record and redirects to 'Service Head List' screen when user clicks on 'Save' Button. (if data is valid)
* Version                               : 1.0
...
public class Admin_TC_0175_VerifyAdminApplicationSaveTheRecordAndRedirectsToServiceHeadListScreenWhenUserClicksOnSaveButtonIfDataIsValid {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0175";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0175_VerifyAdminApplicationSaveTheRecordAndRedirectsToServiceHeadListScreenWhenUserClicksOnSaveButtonIfDataIsValid(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editServiceManagementHeadsListPage.clickOnSave(Log);
				Pages.editServiceManagementHeadsListPage.verifyServiceHeadsUpdatedSuccessfullyConformationMessage(testdatamap,Log);
				Pages.serviceManagementHeadsListPage.verifyServiceHeadsListPageIsDisplayed(Log);
