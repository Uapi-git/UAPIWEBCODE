/**
 *
 * Test Script Name                      : Admin_TC_0298_VerifyUAPIAdminApplicationNavigateTheUserBackToClientSubscriptionPageWhenClickOnBackButton.
 * Test data sheet Name                  : Admin_TC_0298
 * Objective                             : Verify UAPI Admin application  Navigate the user back to 'Client Subscription' page when click on "Back" button.
 * Version                               : 1.0
...
public class Admin_TC_0298_VerifyUAPIAdminApplicationNavigateTheUserBackToClientSubscriptionPageWhenClickOnBackButton {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0298";
    ...
    public Admin_TC_0298_VerifyUAPIAdminApplicationNavigateTheUserBackToClientSubscriptionPageWhenClickOnBackButton(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.clickOnBackBtnInPackageDetailPopup(Log);
