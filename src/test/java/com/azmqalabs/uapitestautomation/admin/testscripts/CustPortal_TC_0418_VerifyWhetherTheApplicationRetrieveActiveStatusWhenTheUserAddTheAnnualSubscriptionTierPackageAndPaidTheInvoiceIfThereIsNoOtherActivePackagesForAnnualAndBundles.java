/**
 * Test Script Name                      : CustPortal_TC_0418_VerifyWhetherTheApplicationRetrieveActiveStatusWhenTheUserAddTheAnnualSubscriptionTierPackageAndPaidTheInvoiceIfThereIsNoOtherActivePackagesForAnnualAndBundles.
 * Test data sheet Name                  : CustPortal_TC_0418
 * Objective                             : Verify whether the Application retrieve 'Active' status when the user add the Annual Subscription Tier package and paid the invoice if there is no other active packages for Annual and bundles.
 * Version                               : 1.0
...
public class CustPortal_TC_0418_VerifyWhetherTheApplicationRetrieveActiveStatusWhenTheUserAddTheAnnualSubscriptionTierPackageAndPaidTheInvoiceIfThereIsNoOtherActivePackagesForAnnualAndBundles {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0418";
...
public CustPortal_TC_0418_VerifyWhetherTheApplicationRetrieveActiveStatusWhenTheUserAddTheAnnualSubscriptionTierPackageAndPaidTheInvoiceIfThereIsNoOtherActivePackagesForAnnualAndBundles(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerAddPackagePage.verifyAvailablePackagesList(testdatamap,Log);
        Pages.customerAddPackagePage.clickOnAvailablePackageBasedOnPackageName(testdatamap,Log);
        Pages.customerAddPackagePage.clickOnGenerateInvoiceButton(Log);
        Pages.customerAddPackagePage.clickOnAreYouSureYouWantToSelectThisPackagePopUpYesBtn(Log);
        Pages.customerAddPackagePage.selectActivationDateInAddNewAnnualSubscriptionTierPopUp(testdatamap,Log);
        Pages.customerAddPackagePage.clickOnAddNewAnnualSubscriptionTierPopUpSaveBtn(Log);
        Pages.customerAddPackagePage.verifyAnnualPackageWillBeActivatedOnTheActivationDatePopUp(Log);
        Pages.customerAddPackagePage.clickOnYesBtnInAnnualPackageWillBeActivatedOnTheActivationDatePopUp(Log);
        Pages.customerPackageManagementPage.searchAnnualPackageName(testdatamap,Log);
        Pages.customerPackageManagementPage.setGeneratedInvoicePackageName(testdatamap);
        Pages.customerPackageManagementPage.VerifyRecordIsSavedAfterRenewOrGenerateInvoiceForThePackage(Log);
