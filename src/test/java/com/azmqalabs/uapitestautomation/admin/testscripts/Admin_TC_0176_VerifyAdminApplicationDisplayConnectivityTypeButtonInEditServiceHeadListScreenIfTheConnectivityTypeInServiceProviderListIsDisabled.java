/**
*
* Test Script Name                      : Admin_TC_0176_VerifyAdminApplicationDisplayConnectivityTypeButtonInEditServiceHeadListScreenIfTheConnectivityTypeInServiceProviderListIsDisabled
* TestDataSheet                         : Admin_TC_0176
* Objective                             : Verify UAPI Admin application  display a 'Connectivity Type' button if the "Connectivity Type" in service provider list is disabled.
* Version                               : 1.0
...
public class Admin_TC_0176_VerifyAdminApplicationDisplayConnectivityTypeButtonInEditServiceHeadListScreenIfTheConnectivityTypeInServiceProviderListIsDisabled {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0176";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0176_VerifyAdminApplicationDisplayConnectivityTypeButtonInEditServiceHeadListScreenIfTheConnectivityTypeInServiceProviderListIsDisabled(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws Exception{
	        try{
				...
				Pages.editServiceManagementHeadsListPage.verifyConnectivityTypeSaveAndViewCredentialsButtonIsDisplayed(Log);
				Pages.serviceManagementProvidersListPage.clickOnServiceProvidersList(Log);
				Pages.serviceManagementProvidersListPage.clickOnActionButton(Log);
				Pages.serviceManagementProvidersListPage.clickOnEdit(Log);
