/**
*
* Test Script Name                      : Admin_TC_024_VerifyAdminApplicationValidatesAllTheDataInEditAccountScreen
* TestDataSheet                         : Admin_TC_024
* Objective                             : Verify whether, on click of 'Save' button, UAPI admin application validates all the data in all below tabs under Edit Account screen.
* Version                               : 1.0
...
public class Admin_TC_024_VerifyAdminApplicationValidatesAllTheDataInEditAccountScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_024";
	private webDriverEventListener eventListener;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_024_VerifyAdminApplicationValidatesAllTheDataInEditAccountScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editAccountManagementPage.verifyErrorMessagesInEditAccountManagementScreen(testdatamap,Log);
