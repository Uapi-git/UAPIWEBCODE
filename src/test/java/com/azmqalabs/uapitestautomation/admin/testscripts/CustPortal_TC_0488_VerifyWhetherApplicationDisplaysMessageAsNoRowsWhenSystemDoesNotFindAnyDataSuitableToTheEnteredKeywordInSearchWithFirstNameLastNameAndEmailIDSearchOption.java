/**
 * Test Script Name                      : CustPortal_TC_0488_VerifyWhetherApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableToTheEnteredKeywordInSearchWithFirstNameLastNameAndEmailIDSearchOption.
 * Test data sheet Name                  : CustPortal_TC_0488
 * Objective                             : Verify whether Application displays message as 'No Rows' when system does not find any data suitable to the entered keyword in 'Search with First Name, Last Name and Email ID' search option.
 * Version                               : 1.0
...
public class CustPortal_TC_0488_VerifyWhetherApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableToTheEnteredKeywordInSearchWithFirstNameLastNameAndEmailIDSearchOption {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0488";
...
public CustPortal_TC_0488_VerifyWhetherApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableToTheEnteredKeywordInSearchWithFirstNameLastNameAndEmailIDSearchOption(Map<Object, Object> testdatamap) {
