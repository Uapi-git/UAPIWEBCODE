/**
*
* Test Script Name                      : Admin_TC_0227_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInInvoiceManagementScreen
* TestDataSheet                         : Admin_TC_0227
...
public class Admin_TC_0227_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInInvoiceManagementScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0227";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0227_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInInvoiceManagementScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.invoiceManagementPage.verifyGridData(Log);
				Pages.invoiceManagementPage.clickOnPegination();
				Pages.invoiceManagementPage.selectPeginationValueFive(Log);
				Pages.invoiceManagementPage.verifySelectedRowPerPageData(Log);
