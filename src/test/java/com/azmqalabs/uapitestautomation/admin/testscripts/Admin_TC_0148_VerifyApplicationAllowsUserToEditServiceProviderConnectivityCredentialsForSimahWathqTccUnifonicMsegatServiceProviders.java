/**
*
* Test Script Name                      : Admin_TC_0148_VerifyApplicationAllowsUserToEditServiceProviderConnectivityCredentialsForSimahWathqTccUnifonicMsegatServiceProviders
* TestDataSheet                         : Admin_TC_0148_Simah
* Objective                             : Verify whether UAPI Admin Application allows user to edit below details under the 'Service provider connectivity credentials' popup box For (SIMAH, WATHQ, TCC, UNIFONIC, MSEGAT)
* Version                               : 1.0
...
public class Admin_TC_0148_VerifyApplicationAllowsUserToEditServiceProviderConnectivityCredentialsForSimahWathqTccUnifonicMsegatServiceProviders {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0148_Simah";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0148_VerifyApplicationAllowsUserToEditServiceProviderConnectivityCredentialsForSimahWathqTccUnifonicMsegatServiceProviders(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.serviceManagementProvidersListPage.clickOnActionButtonBasedOnServiceProviderName(testdatamap,Log);
				Pages.serviceManagementProvidersListPage.clickOnEdit(Log);
				Pages.editServiceProviderListPage.clickOnSaveAndViewCredentials(Log);
				Pages.editServiceProviderListPage.verifyServiceProviderConnectivityPopupEditableForSimah(testdatamap,Log);
