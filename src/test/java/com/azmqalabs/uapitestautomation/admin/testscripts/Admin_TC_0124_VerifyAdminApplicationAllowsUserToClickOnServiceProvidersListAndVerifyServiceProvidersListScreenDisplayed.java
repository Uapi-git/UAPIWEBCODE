/**
*
* Test Script Name                      : Admin_TC_0124_VerifyAdminApplicationAllowsUserToClickOnServiceProvidersListAndVerifyServiceProvidersListScreenDisplayed
* TestDataSheet                         : Admin_TC_0124
* Objective                             : Verify whether UAPI Admin Application allows user to click on 'Service Providers List' submenu and on click UAPI Admin Application displays the Service Providers List screen at the Right pane.
* Version                               : 1.0
...
public class Admin_TC_0124_VerifyAdminApplicationAllowsUserToClickOnServiceProvidersListAndVerifyServiceProvidersListScreenDisplayed {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0124";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0124_VerifyAdminApplicationAllowsUserToClickOnServiceProvidersListAndVerifyServiceProvidersListScreenDisplayed(Map<Object, Object> testdatamap){
