/**
*
* Test Script Name                      : Admin_TC_0170_VerifyAdminApplicationDisplaysTheServiceHeadsDetailsInNonEditableOrViewModeWhenUserClicksOnViewOption
* TestDataSheet                         : Admin_TC_0170
...
public class Admin_TC_0170_VerifyAdminApplicationDisplaysTheServiceHeadsDetailsInNonEditableOrViewModeWhenUserClicksOnViewOption {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0170";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0170_VerifyAdminApplicationDisplaysTheServiceHeadsDetailsInNonEditableOrViewModeWhenUserClicksOnViewOption(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.serviceManagementHeadsListPage.verifyViewModeAfterClickOnViewFromActionList();
