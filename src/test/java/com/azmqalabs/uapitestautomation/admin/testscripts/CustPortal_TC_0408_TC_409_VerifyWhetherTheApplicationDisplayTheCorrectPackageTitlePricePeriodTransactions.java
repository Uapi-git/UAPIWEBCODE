/**
 * Test Script Name                      : CustPortal_TC_0408_TC_409_VerifyWhetherTheApplicationDisplayTheCorrectPackageTitlePricePeriodTransactions.
 * Test data sheet Name                  : CustPortal_TC_0408_TC_0409
 * Objective                             : 1.Verify whether the Application display the correct package title, Price, Period, Transactions. 2. Verify whether application opens 'Add New Annual Subscription Tier' popup with 'Save' and 'Cancel' option and displays below details and allow user to select Date of activation.
 * Version                               : 1.0
...
public class CustPortal_TC_0408_TC_409_VerifyWhetherTheApplicationDisplayTheCorrectPackageTitlePricePeriodTransactions {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0408_TC_409";
...
public CustPortal_TC_0408_TC_409_VerifyWhetherTheApplicationDisplayTheCorrectPackageTitlePricePeriodTransactions(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerAddPackagePage.verifyAddNewAnnualSubscriptionTierPopUpPackageDetails(testdatamap,Log);
