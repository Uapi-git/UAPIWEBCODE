/**
 * Test Script Name                      : CustPortal_TC_0413_VerifyWhetherApplicationDisplaysBelowConfirmationPopupMessageWithYesAndNoOptionTheAnnualPackageWillBeActivatedOnTheActivationDateTheInvoiceWillBeGeneratedDoYouWantToProceed.
 * Test data sheet Name                  : CustPortal_TC_0413
 * Objective                             : Verify whether application displays below confirmation popup message with 'Yes' and 'No' option.'The Annual Package will be activated on the `Activation date`.The Invoice will be generated. Do you want to proceed?'
 * Version                               : 1.0
...
public class CustPortal_TC_0413_VerifyWhetherApplicationDisplaysBelowConfirmationPopupMessageWithYesAndNoOptionTheAnnualPackageWillBeActivatedOnTheActivationDateTheInvoiceWillBeGeneratedDoYouWantToProceed {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0413";
...
public CustPortal_TC_0413_VerifyWhetherApplicationDisplaysBelowConfirmationPopupMessageWithYesAndNoOptionTheAnnualPackageWillBeActivatedOnTheActivationDateTheInvoiceWillBeGeneratedDoYouWantToProceed(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerAddPackagePage.clickOnAnnualPackageWillBeActivatedOnTheActivationDatePopUpCloseBtn();
