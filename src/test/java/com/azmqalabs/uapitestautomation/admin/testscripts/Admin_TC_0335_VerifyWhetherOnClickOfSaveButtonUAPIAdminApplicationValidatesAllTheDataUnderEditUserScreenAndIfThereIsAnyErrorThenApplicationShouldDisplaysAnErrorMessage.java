/**
 * Test Script Name                      : Admin_TC_0335_VerifyWhetherOnClickOfSaveButtonUAPIAdminApplicationValidatesAllTheDataUnderEditUserScreenAndIfThereIsAnyErrorThenApplicationShouldDisplaysAnErrorMessage.
 * Test data sheet Name                  : Admin_TC_0335
 * Objective                             : Verify whether, on click of 'Save' button, UAPI admin application validates all the data under Edit User screen and if there is any error, then application should displays an error message.
 * Version                               : 1.0
...
public class Admin_TC_0335_VerifyWhetherOnClickOfSaveButtonUAPIAdminApplicationValidatesAllTheDataUnderEditUserScreenAndIfThereIsAnyErrorThenApplicationShouldDisplaysAnErrorMessage {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0335";
    ...
    public Admin_TC_0335_VerifyWhetherOnClickOfSaveButtonUAPIAdminApplicationValidatesAllTheDataUnderEditUserScreenAndIfThereIsAnyErrorThenApplicationShouldDisplaysAnErrorMessage(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.editUserPage.enterInvalidDataInEditUserPageAndVerifyErrorMSG(testdatamap,Log);
