/**
*
* Test Script Name                      : Customer_TC_0625_VerifyServicesResponseUnderYakeenAddressInfoNonSaudiByIqamaInElmOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0625
* Objective                             : Verify services response under 'Yakeen Address Info Non Saudi By Iqama' in 'Elm' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0625_VerifyServicesResponseUnderYakeenAddressInfoNonSaudiByIqamaInElmOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0625";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0625_VerifyServicesResponseUnderYakeenAddressInfoNonSaudiByIqamaInElmOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterUsageCode(testdatamap,Log);
				Pages.customerServicesPage.enterIqamaNumber(testdatamap,Log);
				Pages.customerServicesPage.enterBirthDateG(testdatamap,Log);
