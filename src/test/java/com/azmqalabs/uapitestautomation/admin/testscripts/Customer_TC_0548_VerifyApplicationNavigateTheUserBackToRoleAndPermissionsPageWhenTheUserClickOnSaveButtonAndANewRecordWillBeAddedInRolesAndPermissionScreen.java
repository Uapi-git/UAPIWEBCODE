/**
*
* Test Script Name                      : Customer_TC_0548_VerifyApplicationNavigateTheUserBackToRoleAndPermissionsPageWhenTheUserClickOnSaveButtonAndANewRecordWillBeAddedInRolesAndPermissionScreen
* TestDataSheet                         : Customer_TC_0548
* Objective                             : Verify whether the Application navigate the user back to 'Role & Permissions' page when the user click on 'Save' button and a new record will be added.
* Version                               : 1.0
...
Customer_TC_0548_VerifyApplicationNavigateTheUserBackToRoleAndPermissionsPageWhenTheUserClickOnSaveButtonAndANewRecordWillBeAddedInRolesAndPermissionScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0548";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0548_VerifyApplicationNavigateTheUserBackToRoleAndPermissionsPageWhenTheUserClickOnSaveButtonAndANewRecordWillBeAddedInRolesAndPermissionScreen(Map<Object, Object> testdatamap){
