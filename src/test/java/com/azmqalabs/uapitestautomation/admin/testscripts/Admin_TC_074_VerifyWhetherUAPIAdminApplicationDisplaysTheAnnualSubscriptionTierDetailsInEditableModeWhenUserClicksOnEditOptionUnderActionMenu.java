/**
 * Test Script Name                      : Admin_TC_074_VerifyWhetherUAPIAdminApplicationDisplaysTheAnnualSubscriptionTierDetailsInEditableModeWhenUserClicksOnEditOptionUnderActionMenu.
 * Test data sheet Name                  : Admin_TC_074
 * Objective                             : Verify whether UAPI Admin Application displays the Annual Subscription Tier details in editable mode when user clicks on 'Edit' option under Action menu.
 * Version                               : 1.0
...
public class Admin_TC_074_VerifyWhetherUAPIAdminApplicationDisplaysTheAnnualSubscriptionTierDetailsInEditableModeWhenUserClicksOnEditOptionUnderActionMenu {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_074";
    ...
    public Admin_TC_074_VerifyWhetherUAPIAdminApplicationDisplaysTheAnnualSubscriptionTierDetailsInEditableModeWhenUserClicksOnEditOptionUnderActionMenu(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.editPackagePage.verifyEditModeAfterClickOnEditFromActionList();
