/**
 * Test Script Name                      : Admin_TC_0268_VerifyWhetherUAPIAdminApplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationSplitsTheRecordsInMultiplePagesAndDisplaysTheSelectedNOOfRowsRecordsOnOnePage.
 * Test data sheet Name                  : Admin_TC_0268
...
public class Admin_TC_0268_VerifyWhetherUAPIAdminApplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationSplitsTheRecordsInMultiplePagesAndDisplaysTheSelectedNOOfRowsRecordsOnOnePage {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0268";
    ...
    public Admin_TC_0268_VerifyWhetherUAPIAdminApplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationSplitsTheRecordsInMultiplePagesAndDisplaysTheSelectedNOOfRowsRecordsOnOnePage(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.clickOnReportsMenu(Log);
            Pages.reportsPage.clickOnConsumptionDetailsMenu(Log);
            Pages.reportsPage.clickOnActionButtonBasedOnTheAccountName("BlueSky Technologies",Log);
            Pages.reportsPage.clickOnView(Log);
            Pages.reportsConsumptionDetailsPage.verifyDataFieldsUnderConsumptionDetails(Log);
            Pages.reportsConsumptionDetailsPage.selectRowsPerPage(5,Log);
            Pages.reportsConsumptionDetailsPage.clickOnNextPageIconInTable(Log);
            Pages.reportsConsumptionDetailsPage.clickOnPreviousPageIconInTable(Log);
            Pages.reportsConsumptionDetailsPage.VerifyApplicationRetrievesDataSelectedRowsPerPage(5,Log);
