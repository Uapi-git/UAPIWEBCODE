/**
 * Test Script Name                      : CustPortal_TC_0487_VerifyWhetherApplicationFiltersTheUserDataBasedOnTheSearchInputEnteredInSearchWithFirstNameLastNameAndEmailIDAndDisplaysTheResults.
 * Test data sheet Name                  : CustPortal_TC_0487
 * Objective                             : Verify whether Application filters the User data based on the search input entered in 'Search with First Name, Last Name and Email ID' and displays the results.
 * Version                               : 1.0
...
public class CustPortal_TC_0487_VerifyWhetherApplicationFiltersTheUserDataBasedOnTheSearchInputEnteredInSearchWithFirstNameLastNameAndEmailIDAndDisplaysTheResults {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0487";
...
public CustPortal_TC_0487_VerifyWhetherApplicationFiltersTheUserDataBasedOnTheSearchInputEnteredInSearchWithFirstNameLastNameAndEmailIDAndDisplaysTheResults(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerUserManagementPage.verifyGridRecordData(1,testdatamap,Log);
