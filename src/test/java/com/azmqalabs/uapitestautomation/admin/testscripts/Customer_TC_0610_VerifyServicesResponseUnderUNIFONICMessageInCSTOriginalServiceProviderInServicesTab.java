/**
*
* Test Script Name                      : Customer_TC_0610_VerifyServicesResponseUnderUNIFONICMessageInCSTOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0610
* Objective                             : Verify services response under 'UNIFONIC Message' in 'CST' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0610_VerifyServicesResponseUnderUNIFONICMessageInCSTOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0610";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0610_VerifyServicesResponseUnderUNIFONICMessageInCSTOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterSenderId(testdatamap,Log);
				Pages.customerServicesPage.enterRecipient(testdatamap,Log);
				Pages.customerServicesPage.enterBody(testdatamap,Log);
