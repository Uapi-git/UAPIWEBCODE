/**
 * Test Script Name                      : Admin_TC_0337_VerifyWhetherUAPIAdminApplicationDoesNotAllowToChangeTheUserCompanyIfTheSelectedUserIsTheOnlyUserForTheAccount.
 * Test data sheet Name                  : Admin_TC_0337
 * Objective                             : Verify whether UAPI Admin Application does not allow  to change the user company, if the selected user is the only user for the account.
 * Version                               : 1.0
...
public class Admin_TC_0337_VerifyWhetherUAPIAdminApplicationDoesNotAllowToChangeTheUserCompanyIfTheSelectedUserIsTheOnlyUserForTheAccount {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0337";
    ...
    public Admin_TC_0337_VerifyWhetherUAPIAdminApplicationDoesNotAllowToChangeTheUserCompanyIfTheSelectedUserIsTheOnlyUserForTheAccount(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.editUserPage.verifyCompanyFieldIsInactiveToSelect(Log);
