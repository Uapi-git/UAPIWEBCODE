/**
*
* Test Script Name                      : Customer_TC_0604_VerifyServicesResponseUnderYakeenAddressInfoSaudiByNinInElmOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0604
* Objective                             : Verify services response under 'Yakeen Address info Saudi by nin' in 'Elm' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0604_VerifyServicesResponseUnderYakeenAddressInfoSaudiByNinInElmOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0604";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0604_VerifyServicesResponseUnderYakeenAddressInfoSaudiByNinInElmOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterNinNumber(testdatamap,Log);
				Pages.customerServicesPage.enterDate(testdatamap,Log);
