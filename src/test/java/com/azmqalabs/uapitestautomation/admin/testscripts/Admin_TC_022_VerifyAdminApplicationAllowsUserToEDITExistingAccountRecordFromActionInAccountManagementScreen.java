/**
*
* Test Script Name                      : Admin_TC_022_VerifyAdminApplicationAllowsUserToEDITExistingAccountRecordFromActionInAccountManagementScreen
* TestDataSheet                         : Admin_TC_022
* Objective                             : Verify whether UAPI Admin application allows user to EDIT existing account record from 'Action' menu under the 'Account management' screen
* Version                               : 1.0
...
public class Admin_TC_022_VerifyAdminApplicationAllowsUserToEDITExistingAccountRecordFromActionInAccountManagementScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_022";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_022_VerifyAdminApplicationAllowsUserToEDITExistingAccountRecordFromActionInAccountManagementScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editAccountManagementPage.clickOnSaveButton();
				Pages.editAccountManagementPage.verifyAccountDetailsUpdatedToastMessage(testdatamap,Log);
