/**
*
* Test Script Name                      : Customer_TC_0546_VerifyApplicationNavigateTheUserBackToRoleAndPermissionsPageWhenTheUserClickOnCancelButtonInAddRolesAndPermissionScreen
* TestDataSheet                         : Customer_TC_0546
...
Customer_TC_0546_VerifyApplicationNavigateTheUserBackToRoleAndPermissionsPageWhenTheUserClickOnCancelButtonInAddRolesAndPermissionScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0546";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0546_VerifyApplicationNavigateTheUserBackToRoleAndPermissionsPageWhenTheUserClickOnCancelButtonInAddRolesAndPermissionScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerRolesAndPermissionsPage.clickOnCancel(Log);
				Pages.customerRolesAndPermissionsPage.clickOnYesInCancelConformationPopup();
				Pages.customerRolesAndPermissionsPage.verifyRolesAndPermissionPageIsDisplayed(Log);
