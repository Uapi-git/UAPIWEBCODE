/**
 *
 * Test Script Name                      : Admin_TC_0275_VerifyWhetherUAPIAdminApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableToTheSelectedFilterCriteriaUnderConsumptionDetailsScreen.
 * Test data sheet Name                  : Admin_TC_0275
 * Objective                             : Verify whether UAPI Admin Application displays message as 'No Rows' when system does not find any data suitable to the selected filter criteria under Consumption Details screen.
 * Version                               : 1.0
...
public class Admin_TC_0275_VerifyWhetherUAPIAdminApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableToTheSelectedFilterCriteriaUnderConsumptionDetailsScreen {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0275";
    ...
    public Admin_TC_0275_VerifyWhetherUAPIAdminApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableToTheSelectedFilterCriteriaUnderConsumptionDetailsScreen(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.verifyNoRowsMessage(Log);
