/**
 *
 * Test Script Name                      : Admin_TC_0253_VerifyWhetherUAPIAdminApplicationDisplaysDataTableWithBelowDetailsInSelectedAccountCodeScreenServiceSuccessTransactionsFailureTransactionsTotalTransactionsTotalPrice.
 * Test data sheet Name                  : Admin_TC_0253
 * Objective                             : Verify whether UAPI Admin Application displays data table with below details in selected account code screen - Service,Success Transactions,Failure Transactions,Total Transactions,Total Price.
 * Version                               : 1.0
...
public class Admin_TC_0253_VerifyWhetherUAPIAdminApplicationDisplaysDataTableWithBelowDetailsInSelectedAccountCodeScreenServiceSuccessTransactionsFailureTransactionsTotalTransactionsTotalPrice {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0253";
    ...
    public Admin_TC_0253_VerifyWhetherUAPIAdminApplicationDisplaysDataTableWithBelowDetailsInSelectedAccountCodeScreenServiceSuccessTransactionsFailureTransactionsTotalTransactionsTotalPrice(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsConsumptionDetailsPage.verifyConsumptionDetailsPageGridColumnNames();
