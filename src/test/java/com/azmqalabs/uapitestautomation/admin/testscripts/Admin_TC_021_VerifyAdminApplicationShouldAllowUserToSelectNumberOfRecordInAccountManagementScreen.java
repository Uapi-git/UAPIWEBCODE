/**
*
* Test Script Name                      : Admin_TC_021_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInAccountManagementScreen
* TestDataSheet                         : Admin_TC_021
...
public class Admin_TC_021_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInAccountManagementScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_021";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_021_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInAccountManagementScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.accountManagementPage.verifyGridData(Log);
				Pages.accountManagementPage.clickOnPegination();
				Pages.accountManagementPage.selectPeginationValueFive(Log);
				Pages.accountManagementPage.verifySelectedRowPerPageData(Log);
