/**
 * Test Script Name                      : Admin_TC_075_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnCancelButtonOnEditPackageScreenOnClickTheChangesShouldBeDiscardedAndUserShouldBeRedirectedToAnnualSubscriptionTierScreen.
 * Test data sheet Name                  : Admin_TC_075
 * Objective                             : Verify whether UAPI Admin Application allows user to click on 'Cancel' button on 'Edit Package' screen, on click the changes should be discarded and user should be redirected to 'Annual Subscription Tier' screen.
 * Version                               : 1.0
...
public class Admin_TC_075_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnCancelButtonOnEditPackageScreenOnClickTheChangesShouldBeDiscardedAndUserShouldBeRedirectedToAnnualSubscriptionTierScreen {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_075";
    ...
    public Admin_TC_075_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnCancelButtonOnEditPackageScreenOnClickTheChangesShouldBeDiscardedAndUserShouldBeRedirectedToAnnualSubscriptionTierScreen(Map<Object, Object> testdatamap) {
