/**
*
* Test Script Name                      : Admin_TC_0208_VerifyAdminApplicationFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceStatusFilterInInvoiceManagementScreen
* TestDataSheet                         : Admin_TC_0208
* Objective                             : Verify whether UAPI Admin Application filters the Invoice data based on the search option selection in 'Select Invoice Status' filter and displays the results
* Version                               : 1.0
...
public class Admin_TC_0208_VerifyAdminApplicationFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceStatusFilterInInvoiceManagementScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0208";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0208_VerifyAdminApplicationFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceStatusFilterInInvoiceManagementScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.invoiceManagementPage.enterInvoiceStatusInSearchInvoiceStatusSearchOption(testdatamap,Log);
