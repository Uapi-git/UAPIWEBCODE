/**
 * Test Script Name                      : Admin_TC_0106_VerifyWhetherUAPIAdminApplicationDisplaysTheServiceBundlesDetailsInNonEditableOrViewModeWhenUserClicksOnViewOptionUnderActionMenu.
 * Test data sheet Name                  : Admin_TC_0106
 * Objective                             : Verify whether UAPI Admin Application displays the Service Bundles details in non-editable or view mode when user clicks on 'View' option under Action menu.
 * Version                               : 1.0
...
public class Admin_TC_0106_VerifyWhetherUAPIAdminApplicationDisplaysTheServiceBundlesDetailsInNonEditableOrViewModeWhenUserClicksOnViewOptionUnderActionMenu {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0106";
    ...
    public Admin_TC_0106_VerifyWhetherUAPIAdminApplicationDisplaysTheServiceBundlesDetailsInNonEditableOrViewModeWhenUserClicksOnViewOptionUnderActionMenu(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.packageManagementPage.verifyServicesBundlesViewModeAfterClickOnViewFromActionList();
