/**
*
* Test Script Name                      : Customer_TC_0606_VerifyServicesResponseUnderEmitadContractsForBanksInNCGROriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0606
* Objective                             : Verify services response under 'Emitad Contracts for Banks' in 'NCGR' Original Service Provider.
* Version                               : 1.0
...
public class Customer_TC_0606_VerifyServicesResponseUnderEmitadContractsForBanksInNCGROriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0606";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0606_VerifyServicesResponseUnderEmitadContractsForBanksInNCGROriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterContractNumbers(testdatamap,Log);
				Pages.customerServicesPage.enterIdValue(testdatamap,Log);
				Pages.customerServicesPage.selectCR(testdatamap,Log);
