/**
*
* Test Script Name                      : Admin_TC_0200_VerifyAdminApplicationAllowsUserToClickOnInvoiceManagementMenu
* TestDataSheet                         : Admin_TC_0200
* Objective                             : Verify whether UAPI Admin Application allows user to click on 'Invoice Management' menu and on click UAPI Admin Application displays the My Invoices screen at the Right pane.
* Version                               : 1.0
...
public class Admin_TC_0200_VerifyAdminApplicationAllowsUserToClickOnInvoiceManagementMenu {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0200";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0200_VerifyAdminApplicationAllowsUserToClickOnInvoiceManagementMenu(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.invoiceManagementPage.verifyInvoiceManagementPageIsDisplayed(Log);
