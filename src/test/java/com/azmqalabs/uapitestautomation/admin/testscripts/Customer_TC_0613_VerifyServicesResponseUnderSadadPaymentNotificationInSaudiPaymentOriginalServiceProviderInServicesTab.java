/**
*
* Test Script Name                      : Customer_TC_0613_VerifyServicesResponseUnderSadadPaymentNotificationInSaudiPaymentOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0613
* Objective                             : Verify services response under 'Sadad - Payment notification' in 'Saudi Payment' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0613_VerifyServicesResponseUnderSadadPaymentNotificationInSaudiPaymentOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0613";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0613_VerifyServicesResponseUnderSadadPaymentNotificationInSaudiPaymentOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterUrl(testdatamap,Log);
