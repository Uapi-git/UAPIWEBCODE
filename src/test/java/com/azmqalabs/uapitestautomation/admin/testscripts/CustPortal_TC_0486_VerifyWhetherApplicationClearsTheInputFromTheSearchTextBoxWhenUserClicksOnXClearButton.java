/**
 * Test Script Name                      : CustPortal_TC_04846_VerifyWhetherApplicationClearsTheInputFromTheSearchTextBoxWhenUserClicksOnXClearButton.
 * Test data sheet Name                  : CustPortal_TC_0486
 * Objective                             : Verify whether Application clears the input from the search text box, when user clicks on 'X' clear button.
 * Version                               : 1.0
...
public class CustPortal_TC_0486_VerifyWhetherApplicationClearsTheInputFromTheSearchTextBoxWhenUserClicksOnXClearButton {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0486";
...
public CustPortal_TC_0486_VerifyWhetherApplicationClearsTheInputFromTheSearchTextBoxWhenUserClicksOnXClearButton(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerUserManagementPage.clickOnSearchFieldXBtn(Log);
        Pages.customerUserManagementPage.VerifyClearedValueOfSearchField(Log);
