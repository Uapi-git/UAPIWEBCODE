/**
*
* Test Script Name                      : Customer_TC_0574_VerifyApplicationDoNotConsumePriceFromServiceBundlesWhenUseMyCredentialToggleIsEnabledInConnectivityTab
* TestDataSheet                         : Customer_TC_0574
* Objective                             : Verify whether the Application do not consume price from service bundles when 'Use my credential' is enabled.
* Version                               : 1.0
...
public class Customer_TC_0574_VerifyApplicationDoNotConsumePriceFromServiceBundlesWhenUseMyCredentialToggleIsEnabledInConnectivityTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0574";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0574_VerifyApplicationDoNotConsumePriceFromServiceBundlesWhenUseMyCredentialToggleIsEnabledInConnectivityTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerProfilePage.clickOnHomeTab();
				Pages.customerPackageManagementPage.searchServiceBundlePackageNameWithRespectiveStatus(testdatamap,Log);
				Pages.customerPackageManagementPage.verifyPriceConsumptionDataWhenUseMyCredentialsIsEnabled(priceConsumptionValue,Log);
