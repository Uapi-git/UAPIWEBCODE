/**
 * Test Script Name                      : CustPortal_TC_0462_VerifyWhetherUAPICustomerPortalDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableForTheSelectedOptionInSelectInvoiceStatusSearchOption.
 * Test data sheet Name                  : CustPortal_TC_0462
 * Objective                             : Verify whether UAPI Customer Portal displays message as 'No Rows' when system does not find any data suitable for the selected option in  'Select Invoice Status' search option.
 * Version                               : 1.0
...
public class CustPortal_TC_0462_VerifyWhetherUAPICustomerPortalDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableForTheSelectedOptionInSelectInvoiceStatusSearchOption {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0462";
...
public CustPortal_TC_0462_VerifyWhetherUAPICustomerPortalDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableForTheSelectedOptionInSelectInvoiceStatusSearchOption(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerMyInvoicesPage.verifyNoRowsMessage(Log);
