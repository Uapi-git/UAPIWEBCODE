/**
*
* Test Script Name                      : Customer_TC_0537_VerifyApplicationAllowsUserToDeleteAnyPermissionFromTheSelectionBoxByClickingOnXDeleteIconInEditRolesAndPermissionScreen
* TestDataSheet                         : Customer_TC_0537
* Objective                             : Verify whether application allows user to delete any permission from the selection box by clicking on 'X' delete icon.
* Version                               : 1.0
...
Customer_TC_0537_VerifyApplicationAllowsUserToDeleteAnyPermissionFromTheSelectionBoxByClickingOnXDeleteIconInEditRolesAndPermissionScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0537";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0537_VerifyApplicationAllowsUserToDeleteAnyPermissionFromTheSelectionBoxByClickingOnXDeleteIconInEditRolesAndPermissionScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerEditRolesAndPermissionsPage.deleteAnyPermissionsForCustomer(testdatamap,Log);
