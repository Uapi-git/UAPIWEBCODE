/**
 * Test Script Name                      : CustPortal_TC_0461_VerifyWhetherUAPICustomerPortalFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceStatusFilterAndDisplaysTheResults.
 * Test data sheet Name                  : CustPortal_TC_0461
 * Objective                             : Verify whether UAPI Customer Portal filters the Invoice data based on the search option selection in 'Select Invoice Status' filter and displays the results.
 * Version                               : 1.0
...
public class CustPortal_TC_0461_VerifyWhetherUAPICustomerPortalFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceStatusFilterAndDisplaysTheResults {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0461";
...
public CustPortal_TC_0461_VerifyWhetherUAPICustomerPortalFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceStatusFilterAndDisplaysTheResults(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerMyInvoicesPage.clickOnMyInvoicesMenu(Log);
        Pages.customerMyInvoicesPage.searchWithSelectInvoiceStatus(testdatamap,Log);
        Pages.customerMyInvoicesPage.parseMyInvoicesGridData();
        Pages.customerMyInvoicesPage.verifyFilterDataForInvoiceStatusDisplayedAsSelected(testdatamap,Log);
