/**
*
* Test Script Name                      : Customer_TC_0533_VerifyApplicationDisplaysBelowUserDetailsInEditableModeWhenUserClicksOnEditOptionUnderActionMenuInEditRolesAndPermissionsScreen
* TestDataSheet                         : Customer_TC_0533
* Objective                             : Verify whether Application displays below User details in editable mode when user clicks on 'Edit' option under Action menu.
* Version                               : 1.0
...
Customer_TC_0533_VerifyApplicationDisplaysBelowUserDetailsInEditableModeWhenUserClicksOnEditOptionUnderActionMenuInEditRolesAndPermissionsScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0533";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0533_VerifyApplicationDisplaysBelowUserDetailsInEditableModeWhenUserClicksOnEditOptionUnderActionMenuInEditRolesAndPermissionsScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerEditRolesAndPermissionsPage.verifyEditableFieldsInEditRolesAndPermissionScreen();
