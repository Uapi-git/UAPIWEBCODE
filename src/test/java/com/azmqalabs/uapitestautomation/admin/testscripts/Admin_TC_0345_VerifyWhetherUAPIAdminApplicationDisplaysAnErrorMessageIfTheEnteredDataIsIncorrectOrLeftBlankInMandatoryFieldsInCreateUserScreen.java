/**
 * Test Script Name                      : Admin_TC_0345_VerifyWhetherUAPIAdminApplicationDisplaysAnErrorMessageIfTheEnteredDataIsIncorrectOrLeftBlankInMandatoryFieldsInCreateUserScreen.
 * Test data sheet Name                  : Admin_TC_0345
 * Objective                             : Verify whether UAPI Admin Application displays an error message if the entered data is incorrect or left blank in mandatory fields in 'Create User' screen.
 * Version                               : 1.0
...
public class Admin_TC_0345_VerifyWhetherUAPIAdminApplicationDisplaysAnErrorMessageIfTheEnteredDataIsIncorrectOrLeftBlankInMandatoryFieldsInCreateUserScreen {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0345";
    ...
    public Admin_TC_0345_VerifyWhetherUAPIAdminApplicationDisplaysAnErrorMessageIfTheEnteredDataIsIncorrectOrLeftBlankInMandatoryFieldsInCreateUserScreen(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.userManagementPage.clickOnCreateUser(Log);
            Pages.createUserPage.enterInvalidDataInCreateUserPageAndVerifyErrorMSG(testdatamap,Log);
