/**
*
* Test Script Name                      : Customer_TC_0542_VerifyApplicationNavigateTheUserBackToRoleAndPermissionsPageWhenTheUserClickOnCancelButtonInEditRolesAndPermissionScreen
* TestDataSheet                         : Customer_TC_0542
* Objective                             : Verify whether the Application navigate the user back to 'Role & Permissions' page when the user click on 'Cancel' button.
* Version                               : 1.0
...
Customer_TC_0542_VerifyApplicationNavigateTheUserBackToRoleAndPermissionsPageWhenTheUserClickOnCancelButtonInEditRolesAndPermissionScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0542";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0542_VerifyApplicationNavigateTheUserBackToRoleAndPermissionsPageWhenTheUserClickOnCancelButtonInEditRolesAndPermissionScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				String roleName=Pages.customerEditRolesAndPermissionsPage.getRoleNameText();
				Pages.customerEditRolesAndPermissionsPage.enterRoleName(testdatamap,Log);
				Pages.customerEditRolesAndPermissionsPage.clickOnCancel(Log);
				Pages.customerEditRolesAndPermissionsPage.clickOnYesInCancelConformationPopup();
				Pages.customerRolesAndPermissionsPage.verifyRolesAndPermissionPageIsDisplayed(Log);
				Pages.customerRolesAndPermissionsPage.clickOnActionButton(Log);
				Pages.customerRolesAndPermissionsPage.clickOnEdit(Log);
				Pages.customerEditRolesAndPermissionsPage.verifyEditRolesAndPermissionPageIsDisplayed(Log);
				Pages.customerEditRolesAndPermissionsPage.verifyApplicationDiscardChangesInEditRolesAndPermissionScreen(roleName);
