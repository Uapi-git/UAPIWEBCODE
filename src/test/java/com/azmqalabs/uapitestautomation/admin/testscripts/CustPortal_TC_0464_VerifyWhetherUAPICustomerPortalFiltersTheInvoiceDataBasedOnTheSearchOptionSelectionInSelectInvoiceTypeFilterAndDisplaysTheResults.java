/**
 * Test Script Name                      : CustPortal_TC_0464_VerifyWhetherUAPICustomerPortalFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceTypeFilterAndDisplaysTheResults.
 * Test data sheet Name                  : CustPortal_TC_0464
 * Objective                             : Verify whether UAPI Customer Portal filters the Invoice data based on the search option selection in 'Select Invoice Type' filter and displays the results.
 * Version                               : 1.0
...
public class CustPortal_TC_0464_VerifyWhetherUAPICustomerPortalFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceTypeFilterAndDisplaysTheResults {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0464";
...
public CustPortal_TC_0464_VerifyWhetherUAPICustomerPortalFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceTypeFilterAndDisplaysTheResults(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerMyInvoicesPage.searchWithSelectInvoiceType(testdatamap,Log);
        Pages.customerMyInvoicesPage.parseMyInvoicesGridData();
        Pages.customerMyInvoicesPage.verifyFilterDataForInvoiceTypeDisplayedAsSelected(testdatamap,Log);
