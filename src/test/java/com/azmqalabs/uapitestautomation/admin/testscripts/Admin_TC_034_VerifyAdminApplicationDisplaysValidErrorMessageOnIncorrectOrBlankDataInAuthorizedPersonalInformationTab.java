/**
*
* Test Script Name                      : Admin_TC_034_VerifyAdminApplicationDisplaysValidErrorMessageOnnIncorrectOrBlankDataInAuthorizedPersonalInformationTab
* TestDataSheet                         : Admin_TC_034
* Objective                             : Verify whether UAPI Admin application displays valid error message on incorrect details or blank data in mandatory field in 'Authorized Personal Information tab
* Version                               : 1.0
...
public class Admin_TC_034_VerifyAdminApplicationDisplaysValidErrorMessageOnIncorrectOrBlankDataInAuthorizedPersonalInformationTab {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_034";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_034_VerifyAdminApplicationDisplaysValidErrorMessageOnIncorrectOrBlankDataInAuthorizedPersonalInformationTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.verifyAuthorizedPersonInfoErrorMessage(testdatamap,Log);
