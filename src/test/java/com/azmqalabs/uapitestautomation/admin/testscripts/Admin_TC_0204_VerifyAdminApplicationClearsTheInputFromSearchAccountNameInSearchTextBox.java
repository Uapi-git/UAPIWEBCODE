/**
*
* Test Script Name                      : Admin_TC_0204_VerifyAdminApplicationClearsTheInputFromSearchAccountNameInSearchTextBox
* TestDataSheet                         : Admin_TC_0204
* Objective                             : Verify whether UAPI Admin application clears the input from the 'Search Account Name' search text box, when user clicks on 'X' clear button
* Version                               : 1.0
...
public class Admin_TC_0204_VerifyAdminApplicationClearsTheInputFromSearchAccountNameInSearchTextBox {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0204";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0204_VerifyAdminApplicationClearsTheInputFromSearchAccountNameInSearchTextBox(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.invoiceManagementPage.verifySearchTextFieldIsCleared(testdatamap,Log);
