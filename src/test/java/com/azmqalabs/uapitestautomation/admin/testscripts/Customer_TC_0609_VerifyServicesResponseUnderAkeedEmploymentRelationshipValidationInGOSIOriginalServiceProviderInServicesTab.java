/**
*
* Test Script Name                      : Customer_TC_0609_VerifyServicesResponseUnderAkeedEmploymentRelationshipValidationInGOSIOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0609
* Objective                             : Verify services response under 'Akeed Employment Relationship Validation' in 'GOSI' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0609_VerifyServicesResponseUnderAkeedEmploymentRelationshipValidationInGOSIOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0609";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0609_VerifyServicesResponseUnderAkeedEmploymentRelationshipValidationInGOSIOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterUnifiedID(testdatamap,Log);
				Pages.customerServicesPage.enterNinOrIqamaNumber(testdatamap,Log);
