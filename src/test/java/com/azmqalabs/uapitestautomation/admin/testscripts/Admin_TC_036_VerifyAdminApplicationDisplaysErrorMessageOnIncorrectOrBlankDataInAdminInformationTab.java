/**
*
* Test Script Name                      : Admin_TC_036_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDataInAdminInformationTab
* TestDataSheet                         : Admin_TC_036
* Objective                             : Verify whether UAPI Admin application displays valid error message on incorrect details or blank data in mandatory field in 'Admin Information' tab
* Version                               : 1.0
...
public class Admin_TC_036_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDataInAdminInformationTab {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_036";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_036_VerifyAdminApplicationDisplaysErrorMessageOnIncorrectOrBlankDataInAdminInformationTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.verifyAdminInformationErrorMessage(testdatamap,Log);
