/**
*
* Test Script Name                      : Admin_TC_041_VerifyAdminApplicationAllowsUserFillDetailsInSettingsTabUnderCreateAccountPage
* TestDataSheet                         : Admin_TC_041
* Objective                             : Verify whether user should be able to fill below details in 'Settings' tab under 'Create Account' page.
* Version                               : 1.0
...
public class Admin_TC_041_VerifyAdminApplicationAllowsUserFillDetailsInSettingsTabUnderCreateAccountPage {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_041";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_041_VerifyAdminApplicationAllowsUserFillDetailsInSettingsTabUnderCreateAccountPage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.clickOnAllowPostPayAccess();
				...
				Pages.createAccountManagementPage.verifySettingDetailsFilledSuccessful(Log);
