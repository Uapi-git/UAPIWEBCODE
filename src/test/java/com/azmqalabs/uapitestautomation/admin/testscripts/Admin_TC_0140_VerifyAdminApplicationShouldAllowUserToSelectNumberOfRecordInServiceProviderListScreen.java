/**
*
* Test Script Name                      : Admin_TC_0140_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInServiceProviderListScreen
* TestDataSheet                         : Admin_TC_0140
...
public class Admin_TC_0140_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInServiceProviderListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0140";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0140_VerifyAdminApplicationShouldAllowUserToSelectNumberOfRecordInServiceProviderListScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.serviceManagementProvidersListPage.clickOnPegination();
				Pages.serviceManagementProvidersListPage.selectPeginationValueFive(Log);
				Pages.serviceManagementProvidersListPage.verifySelectedRowPerPageData(Log);
