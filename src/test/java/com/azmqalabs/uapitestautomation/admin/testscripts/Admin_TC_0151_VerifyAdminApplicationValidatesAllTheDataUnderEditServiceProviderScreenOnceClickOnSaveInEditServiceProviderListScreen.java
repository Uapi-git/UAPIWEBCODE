/**
*
* Test Script Name                      : Admin_TC_0151_VerifyAdminApplicationValidatesAllTheDataUnderEditServiceProviderScreenOnceClickOnSave
* TestDataSheet                         : Admin_TC_0151
* Objective                             : Verify whether, on click of 'Save' button, UAPI admin application validates all the data under Edit Service Provider screen.
* Version                               : 1.0
...
public class Admin_TC_0151_VerifyAdminApplicationValidatesAllTheDataUnderEditServiceProviderScreenOnceClickOnSaveInEditServiceProviderListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0151";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0151_VerifyAdminApplicationValidatesAllTheDataUnderEditServiceProviderScreenOnceClickOnSaveInEditServiceProviderListScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editServiceProviderListPage.enterServiceProviderNameArabic(testdatamap,Log);
				Pages.editServiceProviderListPage.verifyErrorMessageForServiceProviderNameArabic(testdatamap,Log);
