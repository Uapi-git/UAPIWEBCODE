/**
 * Test Script Name                      : Admin_TC_0108_VerifyWhetherOnClickOfSaveButtonUAPIAdminApplicationValidatesAllTheDataAndIfThereIsAnyErrorThenApplicationShouldDisplaysAnErrorMessage.
 * Test data sheet Name                  : Admin_TC_0108
 * Objective                             : Verify whether, on click of 'Save' button, UAPI admin application validates all the data And if there is any error, then application should displays an error message.
 * Version                               : 1.0
...
public class Admin_TC_0108_VerifyWhetherOnClickOfSaveButtonUAPIAdminApplicationValidatesAllTheDataAndIfThereIsAnyErrorThenApplicationShouldDisplaysAnErrorMessage {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0108";
    ...
    public Admin_TC_0108_VerifyWhetherOnClickOfSaveButtonUAPIAdminApplicationValidatesAllTheDataAndIfThereIsAnyErrorThenApplicationShouldDisplaysAnErrorMessage(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.editPackagePage.enterInvalidDataInServiceBundleEditPageAndVerifyErrorMSG(testdatamap,Log);
