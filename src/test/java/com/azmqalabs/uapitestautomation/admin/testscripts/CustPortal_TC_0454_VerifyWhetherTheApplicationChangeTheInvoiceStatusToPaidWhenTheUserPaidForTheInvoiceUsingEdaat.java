/**
 * Test Script Name                      : CustPortal_TC_0454_VerifyWhetherTheApplicationChangeTheInvoiceStatusToPaidWhenTheUserPaidForTheInvoiceUsingEdaat.
 * Test data sheet Name                  : CustPortal_TC_0454
 * Objective                             : Verify whether the Application change the invoice status to 'Paid' when the user paid for the invoice using 'Edaat'.
 * Version                               : 1.0
...
public class CustPortal_TC_0454_VerifyWhetherTheApplicationChangeTheInvoiceStatusToPaidWhenTheUserPaidForTheInvoiceUsingEdaat {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0454";
...
public CustPortal_TC_0454_VerifyWhetherTheApplicationChangeTheInvoiceStatusToPaidWhenTheUserPaidForTheInvoiceUsingEdaat(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerAddPackagePage.preconditionToSubscribePackage(testdatamap);
        Pages.customerMyInvoicesPage.clickOnMyInvoicesMenu(Log);
        Pages.customerMyInvoicesPage.verifyDataFieldsInTable(Log);
        Pages.customerMyInvoicesPage.searchPackageName(testdatamap,Log);
        Pages.customerMyInvoicesPage.verifyApplicationAddedNewInvoiceForAddedPackage(Pages.customerAddPackagePage.generatedPackageDate,testdatamap,Log);
