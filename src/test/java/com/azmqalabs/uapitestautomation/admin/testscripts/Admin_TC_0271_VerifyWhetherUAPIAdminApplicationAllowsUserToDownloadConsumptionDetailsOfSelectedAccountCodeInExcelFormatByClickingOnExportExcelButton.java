/**
 *
 * Test Script Name                      : Admin_TC_0271_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadConsumptionDetailsOfSelectedAccountCodeInExcelFormatByClickingOnExportExcelButton.
 * Test data sheet Name                  : Admin_TC_0271
 * Objective                             : Verify whether UAPI Admin Application allows user to download Consumption Details of selected account code in pdf format by clicking on 'Export Excel' button.
 * Version                               : 1.0
...
public class Admin_TC_0271_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadConsumptionDetailsOfSelectedAccountCodeInExcelFormatByClickingOnExportExcelButton {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0271";
    ...
    public Admin_TC_0271_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadConsumptionDetailsOfSelectedAccountCodeInExcelFormatByClickingOnExportExcelButton(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsConsumptionDetailsPage.clickOnExportExcelButton(Log);
            Pages.reportsConsumptionDetailsPage.verifyDownloadedFileFormat("ConsumptionReport_","xlsx");
