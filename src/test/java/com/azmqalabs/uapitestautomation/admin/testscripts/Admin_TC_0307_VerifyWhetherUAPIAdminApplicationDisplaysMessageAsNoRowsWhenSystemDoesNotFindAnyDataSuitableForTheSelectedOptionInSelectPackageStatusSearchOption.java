/**
 *
 * Test Script Name                      : Admin_TC_0307_VerifyWhetherUAPIAdminApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableForTheSelectedOptionInSelectPackageStatusSearchOption.
 * Test data sheet Name                  : Admin_TC_0307
 * Objective                             : Verify whether UAPI Admin Application displays message as 'No Rows' when system does not find any data suitable for the selected option in  'Select Package Status' search option.
 * Version                               : 1.0
...
public class Admin_TC_0307_VerifyWhetherUAPIAdminApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableForTheSelectedOptionInSelectPackageStatusSearchOption {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0307";
    ...
    public Admin_TC_0307_VerifyWhetherUAPIAdminApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataSuitableForTheSelectedOptionInSelectPackageStatusSearchOption(Map<Object, Object> testdatamap) {
