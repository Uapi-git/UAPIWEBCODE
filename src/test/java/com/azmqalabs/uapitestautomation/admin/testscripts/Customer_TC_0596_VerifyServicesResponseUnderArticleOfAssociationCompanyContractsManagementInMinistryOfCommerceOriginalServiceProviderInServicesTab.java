/**
*
* Test Script Name                      : Customer_TC_0596_VerifyServicesResponseUnderArticleOfAssociationCompanyContractsManagementInMinistryOfCommerceOriginalServiceProviderInServicesTab
* TestDataSheet                         : Customer_TC_0596
* Objective                             : Verify services response under 'Article of Association Company Contracts Management' in 'Ministry of Commerce' Original Service Provider
* Version                               : 1.0
...
public class Customer_TC_0596_VerifyServicesResponseUnderArticleOfAssociationCompanyContractsManagementInMinistryOfCommerceOriginalServiceProviderInServicesTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0596";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0596_VerifyServicesResponseUnderArticleOfAssociationCompanyContractsManagementInMinistryOfCommerceOriginalServiceProviderInServicesTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerServicesPage.enterCrNumber(testdatamap,Log);
