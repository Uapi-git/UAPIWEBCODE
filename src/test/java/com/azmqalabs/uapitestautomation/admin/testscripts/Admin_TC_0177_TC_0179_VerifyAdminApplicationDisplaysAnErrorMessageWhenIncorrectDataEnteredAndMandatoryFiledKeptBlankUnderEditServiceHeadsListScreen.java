/**
*
* Test Script Name                      : Admin_TC_0177_TC_0179_VerifyAdminApplicationDisplaysAnErrorMessageWhenIncorrectDataEnteredAndMandatoryFiledkeptBlankUnderEditServiceHeadsListScreen
* TestDataSheet                         : Admin_TC_0177_TC_0179
* Objective                             : Verify whether UAPI Admin Application displays an error message when incorrect data entered and mandatory filed kept blank under 'Edit Service Heads List' screen
* Version                               : 1.0
...
public class Admin_TC_0177_TC_0179_VerifyAdminApplicationDisplaysAnErrorMessageWhenIncorrectDataEnteredAndMandatoryFiledKeptBlankUnderEditServiceHeadsListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0177_TC_0179";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0177_TC_0179_VerifyAdminApplicationDisplaysAnErrorMessageWhenIncorrectDataEnteredAndMandatoryFiledKeptBlankUnderEditServiceHeadsListScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws Exception{
	        try{
				...
				Pages.editServiceManagementHeadsListPage.enterServiceHeadNameArabic(testdatamap,Log);
				Pages.editServiceManagementHeadsListPage.verifyErrorMessageForServiceHeadNameArabic(testdatamap,Log);
				Pages.editServiceManagementHeadsListPage.enterDescription(testdatamap);
				Pages.editServiceManagementHeadsListPage.verifyErrorMessageForDescription(testdatamap,Log);
