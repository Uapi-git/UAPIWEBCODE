/**
*
* Test Script Name                      : Customer_TC_0545_VerifyApplicationDoesNotAllowToDeleteRoleIfTheSelectedRoleIsAttachedToAUserInRolesAndPermissionScreen
* TestDataSheet                         : Customer_TC_0545
* Objective                             : Verify whether Application does not allow  to delete role if the selected role is attached to a user.
* Version                               : 1.0
...
Customer_TC_0545_VerifyApplicationDoesNotAllowToDeleteRoleIfTheSelectedRoleIsAttachedToAUserInRolesAndPermissionScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0545";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0545_VerifyApplicationDoesNotAllowToDeleteRoleIfTheSelectedRoleIsAttachedToAUserInRolesAndPermissionScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerRolesAndPermissionsPage.verifyUserNotAbleToDeleteRoleIfRoleIsAttachedToUser(testdatamap,Log);
