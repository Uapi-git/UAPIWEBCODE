/**
*
* Test Script Name                      : Admin_TC_0180_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditServiceHeadListScreenDiscardsChangesAndRedirectsToServiceHeadListScreen
* TestDataSheet                         : Admin_TC_0180
* Objective                             : Verify whether UAPI Admin application allows user to click on 'Cancel' button under Edit Service Head List Screen, on click application discard the changes and close the 'Edit Service Provider' screen and redirects to 'Service Head List page
* Version                               : 1.0
...
public class Admin_TC_0180_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditServiceHeadListScreenDiscardsChangesAndRedirectsToServiceHeadListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0180";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0180_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditServiceHeadListScreenDiscardsChangesAndRedirectsToServiceHeadListScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.serviceManagementHeadsListPage.clickOnServiceHeadList(Log);
				Pages.serviceManagementHeadsListPage.verifyServiceHeadsListPageIsDisplayed(Log);
				Pages.serviceManagementHeadsListPage.verifyGridData(Log);
				Pages.serviceManagementHeadsListPage.clickOnActionButton(Log);
				Pages.serviceManagementHeadsListPage.clickOnEdit(Log);
				String descriptionText=Pages.editServiceManagementHeadsListPage.getDescriptionText();
				Pages.editServiceManagementHeadsListPage.enterDescription(testdatamap);
				Pages.editServiceManagementHeadsListPage.clickOnCancel();
				Pages.serviceManagementHeadsListPage.verifyServiceHeadsListPageIsDisplayed(Log);
				Pages.serviceManagementHeadsListPage.clickOnActionButton(Log);
				Pages.serviceManagementHeadsListPage.clickOnView(Log);
				Pages.serviceManagementHeadsListPage.verifyApplicationDiscardChangesAndRedirectsToServiceProviderListPage(descriptionText);
