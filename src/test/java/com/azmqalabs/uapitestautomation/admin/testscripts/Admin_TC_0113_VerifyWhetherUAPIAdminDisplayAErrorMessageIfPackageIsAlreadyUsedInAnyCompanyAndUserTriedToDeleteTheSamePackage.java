/**
 * Test Script Name                      : Admin_TC_0113_VerifyWhetherUAPIAdminDisplayAErrorMessageIfPackageIsAlreadyUsedInAnyCompanyAndUserTriedToDeleteTheSamePackage.
 * Test data sheet Name                  : Admin_TC_0113
 * Objective                             : Verify whether UAPI Admin display a error message if package is already used in any company and user tried to delete the same Package.
 * Version                               : 1.0
...
public class Admin_TC_0113_VerifyWhetherUAPIAdminDisplayAErrorMessageIfPackageIsAlreadyUsedInAnyCompanyAndUserTriedToDeleteTheSamePackage {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0113";
    ...
    public Admin_TC_0113_VerifyWhetherUAPIAdminDisplayAErrorMessageIfPackageIsAlreadyUsedInAnyCompanyAndUserTriedToDeleteTheSamePackage(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.packageManagementPage.clickOnFirstRecordActionButton(Log);
            ...
            Pages.packageManagementPage.verifyPackageDeleteErrorMSGForAlreadyUsedPackage(Log);
