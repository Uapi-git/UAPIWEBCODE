/**
 * Test Script Name                      : CustPortal_TC_0388_TC_0389_VerifyWhetherUAPICustomerPortalOpensAPopupAndDisplaysThePackageDetailsViewModeWhenUserClicksOnViewOptionUnderActionMenu.
 * Test data sheet Name                  : CustPortal_TC_0388_TC_0389
 * Objective                             : 1.Verify whether UAPI Customer Portal opens a popup and displays the Package details view mode when user clicks on 'View' option under Action menu. 2.Verify whether the Application navigate the user back to 'Package Management' page when the user click on 'Back' or 'X' icon.
 * Version                               : 1.0
...
import java.util.Map;
        ...
        public class CustPortal_TC_0388_TC_0389_VerifyWhetherUAPICustomerPortalOpensAPopupAndDisplaysThePackageDetailsViewModeWhenUserClicksOnViewOptionUnderActionMenu {
    // DECLARATION SECTION
    static String TestDataTab = "CustPortal_TC_0388_TC_0389";
    ...
    public CustPortal_TC_0388_TC_0389_VerifyWhetherUAPICustomerPortalOpensAPopupAndDisplaysThePackageDetailsViewModeWhenUserClicksOnViewOptionUnderActionMenu(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.customerPackageManagementPage.parseAnnualPackageManagementGridData();
            Pages.customerPackageManagementPage.backToFirstPageAfterParse();
            Pages.customerPackageManagementPage.clickOnFirstRecordActionButton(Log);
            Pages.customerPackageManagementPage.clickOnView(Log);
            Pages.customerPackageManagementPage.verifyPackageDetailsAfterClickOnView(1,Log);
            Pages.customerPackageManagementPage.clickOnPackageDetailsCloseBtn(Log);
            Pages.customerPackageManagementPage.verifyUserRedirectedToPackageManagementPage();
