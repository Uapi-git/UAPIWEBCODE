/**
 * Test Script Name                      : CustPortal_TC_0458_VerifyWhetherUAPICustomerPortalFiltersTheInvoiceDataBasedOnTheSearchInputEnteredInSearchPackageNameAndDisplaysTheResults.
 * Test data sheet Name                  : CustPortal_TC_0458
 * Objective                             : Verify whether UAPI Customer Portal filters the Invoice data based on the search input entered in 'Search Package Name' and displays the results.
 * Version                               : 1.0
...
public class CustPortal_TC_0458_VerifyWhetherUAPICustomerPortalFiltersTheInvoiceDataBasedOnTheSearchInputEnteredInSearchPackageNameAndDisplaysTheResults {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0458";
...
public CustPortal_TC_0458_VerifyWhetherUAPICustomerPortalFiltersTheInvoiceDataBasedOnTheSearchInputEnteredInSearchPackageNameAndDisplaysTheResults(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerMyInvoicesPage.searchPackageName(testdatamap,Log);
        Pages.customerMyInvoicesPage.parseMyInvoicesGridData();
        Pages.customerMyInvoicesPage.backToFirstPageAfterParse();
        Pages.customerMyInvoicesPage.verifyFilterDataForPackageNameDisplayedAsSearch(testdatamap,Log);
