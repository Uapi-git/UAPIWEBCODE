/**
*
* Test Script Name                      : Admin_TC_0206_VerifyAdminApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataInInvoiceManagementScreen
* TestDataSheet                         : Admin_TC_0206
* Objective                             : Verify whether UAPI Admin Application displays message as 'No Rows' when system does not find any data suitable to the entered keyword in 'Search Account Name' search option.
* Version                               : 1.0
...
public class Admin_TC_0206_VerifyAdminApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataInInvoiceManagementScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0206";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0206_VerifyAdminApplicationDisplaysMessageAsNoRowsWhenSystemDoesNotFindAnyDataInInvoiceManagementScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.invoiceManagementPage.enterIncorrectDataInSearchAccountNameSearchOption(testdatamap,Log);
