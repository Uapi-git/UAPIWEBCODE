/**
 * Test Script Name                      : Admin_TC_0249_VerifyWhetherUAPIAdminApplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationSplitsTheRecordsInMultiplePagesAndDisplaysTheSelectedNOOfRowsRecordsOnOnePage.
 * Test data sheet Name                  : Admin_TC_0249
...
public class Admin_TC_0249_VerifyWhetherUAPIAdminApplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationSplitsTheRecordsInMultiplePagesAndDisplaysTheSelectedNOOfRowsRecordsOnOnePage {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0249";
    ...
    public Admin_TC_0249_VerifyWhetherUAPIAdminApplicationShouldAllowUserToSelectNumberOfRecordToBeShownOnPageUsingRowsPerPageOptionAndApplicationSplitsTheRecordsInMultiplePagesAndDisplaysTheSelectedNOOfRowsRecordsOnOnePage(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.verifyDataFieldsUnderConsumptionDetails(Log);
            Pages.reportsPage.selectRowsPerPage(5,Log);
            Pages.reportsPage.clickOnNextPageIconInTable(Log);
            Pages.reportsPage.clickOnPreviousPageIconInTable(Log);
            Pages.reportsPage.VerifyApplicationRetrievesDataSelectedRowsPerPage(5,Log);
