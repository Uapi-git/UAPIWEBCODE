/**
*
* Test Script Name                      : Admin_TC_0148_VerifyApplicationAllowsUserToEditServiceProviderConnectivityCredentialsForYAKEENServiceProviders
* TestDataSheet                         : Admin_TC_0148_Yakeen
* Objective                             : Verify whether UAPI Admin Application allows user to edit below details under the 'Service provider connectivity credentials' popup box For (YAKEEN)
* Version                               : 1.0
...
public class Admin_TC_0148_VerifyApplicationAllowsUserToEditServiceProviderConnectivityCredentialsForYAKEENServiceProviders {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0148_Yakeen";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0148_VerifyApplicationAllowsUserToEditServiceProviderConnectivityCredentialsForYAKEENServiceProviders(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editServiceProviderListPage.verifyServiceProviderConnectivityPopupEditableForYakeen(testdatamap,Log);
