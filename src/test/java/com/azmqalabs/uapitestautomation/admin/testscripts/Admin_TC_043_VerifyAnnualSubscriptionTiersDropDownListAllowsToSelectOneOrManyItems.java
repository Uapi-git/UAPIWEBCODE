/**
*
* Test Script Name                      : Admin_TC_043_VerifyAnnualSubscriptionTiersDropDownListAllowsToSelectOneOrManyItems
* TestDataSheet                         : Admin_TC_043
* Objective                             : Verify whether UAPI admin application displays all the active 'Annual Subscription Tiers' (Dropdown list) in Setting tab under Account Creation. And user should be able to select one or more that one items from dropdown list
* Version                               : 1.0
...
public class Admin_TC_043_VerifyAnnualSubscriptionTiersDropDownListAllowsToSelectOneOrManyItems {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_043";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_043_VerifyAnnualSubscriptionTiersDropDownListAllowsToSelectOneOrManyItems(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.verifySelectedAnnualSubscriptionTiers(testdatamap);
