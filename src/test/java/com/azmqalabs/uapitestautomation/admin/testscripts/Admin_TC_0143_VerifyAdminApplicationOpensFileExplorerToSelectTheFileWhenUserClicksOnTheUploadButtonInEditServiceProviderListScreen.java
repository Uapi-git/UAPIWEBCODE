/**
*
* Test Script Name                      : Admin_TC_0143_VerifyAdminApplicationOpensFileExplorerToSelectTheFileWhenUserClicksOnTheUploadButton
* TestDataSheet                         : Admin_TC_0143
* Objective                             : Verify whether UAPI Admin Application opens a file explorer to select the file when user clicks on the 'Upload' button under the Edit Service Providers screen
* Version                               : 1.0
...
public class Admin_TC_0143_VerifyAdminApplicationOpensFileExplorerToSelectTheFileWhenUserClicksOnTheUploadButtonInEditServiceProviderListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0143";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0143_VerifyAdminApplicationOpensFileExplorerToSelectTheFileWhenUserClicksOnTheUploadButtonInEditServiceProviderListScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editServiceProviderListPage.uploadFile(Log);
				Pages.editServiceProviderListPage.verifyFileUploadedSuccessfully(testdatamap);
