/**
 * Test Script Name                      : Admin_TC_073_VerifyWhetherUAPIAdminApplicationDisplaysTheAnnualSubscriptionTierDetailsInNonEditableOrViewModeWhenUserClicksOnViewOptionUnderActionMenu.
 * Test data sheet Name                  : Admin_TC_073
 * Objective                             : Verify whether UAPI Admin Application displays the Annual Subscription Tier details in non-editable or view mode when user clicks on 'View' option under Action menu.
 * Version                               : 1.0
...
public class Admin_TC_073_VerifyWhetherUAPIAdminApplicationDisplaysTheAnnualSubscriptionTierDetailsInNonEditableOrViewModeWhenUserClicksOnViewOptionUnderActionMenu {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_073";
    ...
    public Admin_TC_073_VerifyWhetherUAPIAdminApplicationDisplaysTheAnnualSubscriptionTierDetailsInNonEditableOrViewModeWhenUserClicksOnViewOptionUnderActionMenu(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.packageManagementPage.clickOnViewOptionFromActionList(Log);
            Pages.packageManagementPage.verifyViewModeAfterClickOnViewFromActionList();
