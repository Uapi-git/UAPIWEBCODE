/**
*
* Test Script Name                      : Admin_TC_0147_VerifyAdminApplicationDisplaysTheServiceProviderConnectivityCredentialsPopupBoxWithCancelAndSaveButton
* TestDataSheet                         : Admin_TC_0147
* Objective                             : Verify whether UAPI Admin Application displays the 'Service provider connectivity credentials' popup box with Cancel and Save button, when user clicks on the 'Save and View Credentials' button under Edit Service Providers screen.
* Version                               : 1.0
...
public class Admin_TC_0147_VerifyAdminApplicationDisplaysTheServiceProviderConnectivityCredentialsPopupBoxWithCancelAndSaveButton {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0147";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0147_VerifyAdminApplicationDisplaysTheServiceProviderConnectivityCredentialsPopupBoxWithCancelAndSaveButton(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editServiceProviderListPage.verifySaveAndCancelInSaveAndViewCredentialsPopup();
				Pages.editServiceProviderListPage.clickOnCancelInSaveAndViewCredentialsPopup();
