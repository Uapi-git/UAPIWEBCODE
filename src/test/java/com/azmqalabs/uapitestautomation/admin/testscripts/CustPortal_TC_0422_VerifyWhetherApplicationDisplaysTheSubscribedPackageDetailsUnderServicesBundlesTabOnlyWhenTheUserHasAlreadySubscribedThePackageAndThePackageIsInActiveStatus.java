/**
 * Test Script Name                      : CustPortal_TC_0422_VerifyWhetherApplicationDisplaysTheSubscribedPackageDetailsUnderServicesBundlesTabOnlyWhenTheUserHasAlreadySubscribedThePackageAndThePackageIsInActiveStatus.
 * Test data sheet Name                  : CustPortal_TC_0422
 * Objective                             : Verify whether application displays the 'Subscribed Package' details under 'Services Bundles' tab only when the user has already subscribed the package and the package is in active status.
 * Version                               : 1.0
...
public class CustPortal_TC_0422_VerifyWhetherApplicationDisplaysTheSubscribedPackageDetailsUnderServicesBundlesTabOnlyWhenTheUserHasAlreadySubscribedThePackageAndThePackageIsInActiveStatus {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0422";
...
public CustPortal_TC_0422_VerifyWhetherApplicationDisplaysTheSubscribedPackageDetailsUnderServicesBundlesTabOnlyWhenTheUserHasAlreadySubscribedThePackageAndThePackageIsInActiveStatus(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerAddPackagePage.verifyAlreadySubscribedBundlePackageDetails(testdatamap,Log);
