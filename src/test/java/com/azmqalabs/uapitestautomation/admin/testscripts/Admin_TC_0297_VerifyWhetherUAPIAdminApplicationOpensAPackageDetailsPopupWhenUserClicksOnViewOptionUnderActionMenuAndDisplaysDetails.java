/**
 *
 * Test Script Name                      : Admin_TC_0297_VerifyWhetherUAPIAdminApplicationOpensAPackageDetailsPopupWhenUserClicksOnViewOptionUnderActionMenuAndDisplaysDetails.
 * Test data sheet Name                  : Admin_TC_0297
 * Objective                             : Verify whether UAPI Admin Application opens a 'Package Details' popup  when user clicks on 'View' option under Action menu and displays below details - Account ID,Account Name,Package Name,Price,Transaction Limit,Transaction Consumption,Available Amount,Price Consumption,Due Date,Status
 * Version                               : 1.0
...
public class Admin_TC_0297_VerifyWhetherUAPIAdminApplicationOpensAPackageDetailsPopupWhenUserClicksOnViewOptionUnderActionMenuAndDisplaysDetails {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0297";
    ...
    public Admin_TC_0297_VerifyWhetherUAPIAdminApplicationOpensAPackageDetailsPopupWhenUserClicksOnViewOptionUnderActionMenuAndDisplaysDetails(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.verifyClientSubscriptionPackageDetailsDetails();
            Pages.reportsPage.clickOnCloseBtnInPackageDetailPopup();
