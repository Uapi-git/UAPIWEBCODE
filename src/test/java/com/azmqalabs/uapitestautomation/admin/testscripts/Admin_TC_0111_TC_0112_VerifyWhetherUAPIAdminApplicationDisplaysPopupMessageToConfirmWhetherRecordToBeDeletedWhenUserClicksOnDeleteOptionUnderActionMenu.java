/**
 * Test Script Name                      : Admin_TC_0111_TC_0112_VerifyWhetherUAPIAdminApplicationDisplaysPopupMessageToConfirmWhetherRecordToBeDeletedWhenUserClicksOnDeleteOptionUnderActionMenu.
 * Test data sheet Name                  : Admin_TC_0111_TC_0112
 * Objective                             : 1.Verify whether UAPI Admin Application displays popup message to confirm whether record to be deleted, when user clicks on 'Delete' option under Action menu. 2.Verify whether UAPI Admin application displays the confirmation message of deleting package.
 * Version                               : 1.0
...
public class Admin_TC_0111_TC_0112_VerifyWhetherUAPIAdminApplicationDisplaysPopupMessageToConfirmWhetherRecordToBeDeletedWhenUserClicksOnDeleteOptionUnderActionMenu {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0111_TC_0112";
    ...
    public Admin_TC_0111_TC_0112_VerifyWhetherUAPIAdminApplicationDisplaysPopupMessageToConfirmWhetherRecordToBeDeletedWhenUserClicksOnDeleteOptionUnderActionMenu(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.addPackagePage.preconditionToAddServicesBundlesPackage(testdatamap);
            Pages.packageManagementPage.clickOnActionButton(Log);
            Pages.packageManagementPage.clickOnDeleteOptionFromActionList(Log);
            Pages.packageManagementPage.verifyDeleteConfirmationPopUpIsDisplayed();
            Pages.packageManagementPage.clickOnDeleteConfirmationYesButton();
            Pages.packageManagementPage.verifyPackageDeletedSuccessfulMsg();
