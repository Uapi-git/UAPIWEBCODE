/**
*
* Test Script Name                      : Customer_TC_0358_VerifyApplicationAllowUserToEnterTheAPIAuthKeyAndClickOnAuthorizeButtonInSwaggerPage
* TestDataSheet                         : Customer_TC_0358
* Objective                             : Verify whether application displays the 'Authorize' button on Swagger page, and on click application opens 'Available authorizations' popup screen and allow user to enter the API Auth Key and click on 'Authorize' button
* Version                               : 1.0
...
public class Customer_TC_0358_VerifyApplicationAllowUserToEnterTheAPIAuthKeyAndClickOnAuthorizeButtonInSwaggerPage {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0358";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0358_VerifyApplicationAllowUserToEnterTheAPIAuthKeyAndClickOnAuthorizeButtonInSwaggerPage(Map<Object, Object> testdatamap){
