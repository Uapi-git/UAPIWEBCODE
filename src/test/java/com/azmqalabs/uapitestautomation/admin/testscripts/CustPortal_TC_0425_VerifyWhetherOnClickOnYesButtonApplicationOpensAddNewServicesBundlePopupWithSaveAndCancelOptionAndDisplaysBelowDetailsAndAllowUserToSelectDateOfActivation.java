/**
 * Test Script Name                      : CustPortal_TC_0425_VerifyWhetherOnClickOnYesButtonApplicationOpensAddNewServicesBundlePopupWithSaveAndCancelOptionAndDisplaysBelowDetailsAndAllowUserToSelectDateOfActivation.
 * Test data sheet Name                  : CustPortal_TC_0425
 * Objective                             : Verify whether on click on 'Yes' button - application opens 'Add New Services Bundle' popup with 'Save' and 'Cancel' option and displays below details and allow user to select Date of activation.
 * Version                               : 1.0
...
public class CustPortal_TC_0425_VerifyWhetherOnClickOnYesButtonApplicationOpensAddNewServicesBundlePopupWithSaveAndCancelOptionAndDisplaysBelowDetailsAndAllowUserToSelectDateOfActivation {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0425";
...
public CustPortal_TC_0425_VerifyWhetherOnClickOnYesButtonApplicationOpensAddNewServicesBundlePopupWithSaveAndCancelOptionAndDisplaysBelowDetailsAndAllowUserToSelectDateOfActivation(Map<Object, Object> testdatamap) {
