/**
 *
 * Test Script Name                      : Admin_TC_0270_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadConsumptionDetailsOfSelectedAccountCodeInPdfFormatByClickingOnExportPDFButton.
 * Test data sheet Name                  : Admin_TC_0270
 * Objective                             : Verify whether UAPI Admin Application allows user to download Consumption Details of selected account code in pdf format by clicking on 'Export PDF' button.
 * Version                               : 1.0
...
public class Admin_TC_0270_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadConsumptionDetailsOfSelectedAccountCodeInPdfFormatByClickingOnExportPDFButton {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0270";
    ...
    public Admin_TC_0270_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadConsumptionDetailsOfSelectedAccountCodeInPdfFormatByClickingOnExportPDFButton(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsConsumptionDetailsPage.clickOnExportPDFButton(Log);
            Pages.reportsConsumptionDetailsPage.verifyDownloadedFileFormat("ConsumptionReport_","pdf");
