/**
 * Test Script Name                      : CustPortal_TC_0448_TC_0449_VerifyWhetherTheApplicationRetrieveActiveStatusWhenTheUserAddTheServiceBundlePackageAndPaidTheInvoiceIfThereIsNoOtherActivePackagesForAnnualAndBundles.
 * Test data sheet Name                  : CustPortal_TC_0448_TC_0449
 * Objective                             : 1.Verify whether the Application retrieve 'Active' status when the user add the Service Bundle package and paid the invoice if there is no other active packages for Annual and bundles. 2.Verify whether the Application retrieve 'Expired' status when the Service Bundle package period is passed.
 * Version                               : 1.0
...
public class CustPortal_TC_0448_TC_0449_VerifyWhetherTheApplicationRetrieveActiveStatusWhenTheUserAddTheServiceBundlePackageAndPaidTheInvoiceIfThereIsNoOtherActivePackagesForAnnualAndBundles {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0448_TC_0449";
...
public CustPortal_TC_0448_TC_0449_VerifyWhetherTheApplicationRetrieveActiveStatusWhenTheUserAddTheServiceBundlePackageAndPaidTheInvoiceIfThereIsNoOtherActivePackagesForAnnualAndBundles(Map<Object, Object> testdatamap) {
