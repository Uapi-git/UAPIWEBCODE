/**
 * Test Script Name                      : CustPortal_TC_0367_VerifyWhetherApplicationFiltersThePackageDataBasedOnTheSearchInputEnteredInSearchPackageNameAndDisplaysTheResults.
 * Test data sheet Name                  : CustPortal_TC_0367
 * Objective                             : Verify whether Application filters the Package data based on the search input entered in 'Search Package Name' and displays the results.
 * Version                               : 1.0
...
public class CustPortal_TC_0367_VerifyWhetherApplicationFiltersThePackageDataBasedOnTheSearchInputEnteredInSearchPackageNameAndDisplaysTheResults {
    // DECLARATION SECTION
    static String TestDataTab = "CustPortal_TC_0367";
    ...
    public CustPortal_TC_0367_VerifyWhetherApplicationFiltersThePackageDataBasedOnTheSearchInputEnteredInSearchPackageNameAndDisplaysTheResults(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.customerPackageManagementPage.verifyPackageManagementGridRecordData(1,testdatamap,Log);
