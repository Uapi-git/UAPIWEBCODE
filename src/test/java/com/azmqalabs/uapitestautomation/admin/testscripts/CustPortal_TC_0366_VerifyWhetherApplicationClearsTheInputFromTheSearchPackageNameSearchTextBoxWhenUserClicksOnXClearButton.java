/**
 * Test Script Name                      : CustPortal_TC_0366_VerifyWhetherApplicationClearsTheInputFromTheSearchPackageNameSearchTextBoxWhenUserClicksOnXClearButton.
 * Test data sheet Name                  : CustPortal_TC_0366
 * Objective                             : Verify whether Application clears the input from the 'Search Package Name' search text box, when user clicks on 'X' clear button.
 * Version                               : 1.0
...
public class CustPortal_TC_0366_VerifyWhetherApplicationClearsTheInputFromTheSearchPackageNameSearchTextBoxWhenUserClicksOnXClearButton {
    // DECLARATION SECTION
    static String TestDataTab = "CustPortal_TC_0366";
    ...
    public CustPortal_TC_0366_VerifyWhetherApplicationClearsTheInputFromTheSearchPackageNameSearchTextBoxWhenUserClicksOnXClearButton(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.customerPackageManagementPage.clickOnSearchFieldClearBtn(Log);
            Pages.customerPackageManagementPage.VerifyClearedValueOfPackageNameSearchField(Log);
