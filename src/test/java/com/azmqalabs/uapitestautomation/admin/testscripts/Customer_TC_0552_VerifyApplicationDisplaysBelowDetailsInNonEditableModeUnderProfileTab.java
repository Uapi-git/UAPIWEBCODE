/**
*
* Test Script Name                      : Customer_TC_0552_VerifyApplicationDisplaysBelowDetailsInNonEditableModeUnderProfileTab
* TestDataSheet                         : Admin_TC_055
* Objective                             : Verify whether Application displays below details in Non-editable mode under 'Profile' tab.
* Version                               : 1.0
...
public class Customer_TC_0552_VerifyApplicationDisplaysBelowDetailsInNonEditableModeUnderProfileTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0552";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0552_VerifyApplicationDisplaysBelowDetailsInNonEditableModeUnderProfileTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerProfilePage.verifyViewModeInProfileTab(Log);
