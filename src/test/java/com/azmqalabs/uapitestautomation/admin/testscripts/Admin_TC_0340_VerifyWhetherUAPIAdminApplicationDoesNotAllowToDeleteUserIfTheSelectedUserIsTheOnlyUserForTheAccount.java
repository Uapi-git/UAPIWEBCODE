/**
 * Test Script Name                      : Admin_TC_0340_VerifyWhetherUAPIAdminApplicationDoesNotAllowToDeleteUserIfTheSelectedUserIsTheOnlyUserForTheAccount.
 * Test data sheet Name                  : Admin_TC_0340
 * Objective                             : Verify whether UAPI Admin Application does not allow  to delete user, if the selected user is the only user for the account..
 * Version                               : 1.0
...
import java.util.Map;
    ...
    public class Admin_TC_0340_VerifyWhetherUAPIAdminApplicationDoesNotAllowToDeleteUserIfTheSelectedUserIsTheOnlyUserForTheAccount {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0340";
    ...
    public Admin_TC_0340_VerifyWhetherUAPIAdminApplicationDoesNotAllowToDeleteUserIfTheSelectedUserIsTheOnlyUserForTheAccount(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.userManagementPage.clickOnRecordActionButtonBasedOnEmailId(testdatamap,Log);
            Pages.userManagementPage.clickOnDeleteOptionFromActionList(Log);
            Pages.userManagementPage.clickOnDeleteConfirmationYesButton();
            Pages.userManagementPage.verifyDeleteErrorMSGForOwnCompanyUser(testdatamap,Log);
