/**
*
* Test Script Name                      : Customer_TC_0572_VerifyApplicationAllowsUserToEnableTheUseMyCredentialsToggleAndEnterTheAPIKeyAndSaveAtTheServiceHeadLevel
* TestDataSheet                         : Customer_TC_0572
* Objective                             : Verify whether application allows user to enable the 'Use my credentials' toggle and enter the API key and save at the service Head level
* Version                               : 1.0
...
public class Customer_TC_0572_VerifyApplicationAllowsUserToEnableTheUseMyCredentialsToggleAndEnterTheAPIKeyAndSaveAtTheServiceHeadLevel {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0572";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0572_VerifyApplicationAllowsUserToEnableTheUseMyCredentialsToggleAndEnterTheAPIKeyAndSaveAtTheServiceHeadLevel(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editServiceProviderListPage.clickOnConnectivityTypeToggleIfTheToggleIsON(Log);
				Pages.editServiceProviderListPage.clickOnSave(Log);
				...
				Pages.customerProfilePage.clickOnServiceProviderExpandMoreIcon(testdatamap,Log);
				Pages.customerProfilePage.clickOnServiceHeadName(testdatamap,Log);
				...
				Pages.customerProfilePage.clickOnApiKeyEyeIcon(Log);
				Pages.customerProfilePage.enterApiKey(testdatamap);
				Pages.customerProfilePage.clickOnApiKeyEyeIcon(Log);
				Pages.customerProfilePage.clickOnSaveButton();
				Pages.customerProfilePage.verifyApiKeySavedSuccessfulToastMessage(Log);
