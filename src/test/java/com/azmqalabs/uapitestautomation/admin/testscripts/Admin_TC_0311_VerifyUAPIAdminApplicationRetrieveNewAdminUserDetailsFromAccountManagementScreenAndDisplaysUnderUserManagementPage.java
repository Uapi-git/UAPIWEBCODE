/**
*
* Test Script Name                      : Admin_TC_0311_VerifyUAPIAdminApplicationRetrieveNewAdminUserDetailsFromAccountManagementScreenAndDisplaysUnderUserManagementPage
* TestDataSheet                         : Admin_TC_0311
* Objective                             : Verify UAPI Admin application retrieve new admin user details from account management screen and displays under User management page.
* Version                               : 1.0
...
public class Admin_TC_0311_VerifyUAPIAdminApplicationRetrieveNewAdminUserDetailsFromAccountManagementScreenAndDisplaysUnderUserManagementPage {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0311";
	...
	private InitializeDriver initializeDriver;
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0311_VerifyUAPIAdminApplicationRetrieveNewAdminUserDetailsFromAccountManagementScreenAndDisplaysUnderUserManagementPage(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.createAccount(testdatamap,Log);
				Pages.userManagementPage.clickOnUserManagementMenu(Log);
				Pages.userManagementPage.validateFirstRecordDataAsSameAsAdminUserInfo(testdatamap,Log);
