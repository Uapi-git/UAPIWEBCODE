/**
*
* Test Script Name                      : Customer_TC_0557_VerifyApplicationAllowsUserToClickOnRegenerateAPIKeyButtonUnderApiKeyTab
* TestDataSheet                         : Customer_TC_0557
* Objective                             : Verify whether application allows user to click on 'Regenerate API Key' button, and on click application displays a confirmation box with 'Yes' and 'No' option.
* Version                               : 1.0
...
public class Customer_TC_0557_VerifyApplicationAllowsUserToClickOnRegenerateAPIKeyButtonUnderApiKeyTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0557";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0557_VerifyApplicationAllowsUserToClickOnRegenerateAPIKeyButtonUnderApiKeyTab(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerProfilePage.clickOnRegenerateApiKey();
				Pages.customerProfilePage.verifyRegeneratePopupDetails(Log);
				Pages.customerProfilePage.clickOnNoInRegenerateApiKeyPopup();
