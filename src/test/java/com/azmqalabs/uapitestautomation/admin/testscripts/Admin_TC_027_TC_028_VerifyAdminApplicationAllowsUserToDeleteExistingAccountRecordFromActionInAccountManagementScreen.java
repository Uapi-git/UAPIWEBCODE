/**
*
* Test Script Name                      : Admin_TC_027_TC_028_VerifyAdminApplicationAllowsUserToDeleteExistingAccountRecordFromActionInAccountManagementScreen
* TestDataSheet                         : Admin_TC_027_TC_028
* Objective                             : Verify whether UAPI Admin application allows user to Delete existing account record from 'Action' menu under the 'Account management' screen
* Version                               : 1.0
* Author                                : Aru Kumar MS
...
public class Admin_TC_027_TC_028_VerifyAdminApplicationAllowsUserToDeleteExistingAccountRecordFromActionInAccountManagementScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_027_TC_028";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_027_TC_028_VerifyAdminApplicationAllowsUserToDeleteExistingAccountRecordFromActionInAccountManagementScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.createAccountManagementPage.enterAuthorizedPersonInfo(testdatamap,Log);
				Pages.createAccountManagementPage.enterAdminInformation(testdatamap,Log);
				Pages.createAccountManagementPage.enterNationalAddressInfo(testdatamap,Log);
				Pages.createAccountManagementPage.attachAttachments(Log);
				Pages.createAccountManagementPage.clickOnAnnualSubscriptionDropdown(Log);
				Pages.createAccountManagementPage.selectAnnualSubscriptionTiers(testdatamap);
				Pages.createAccountManagementPage.clickOnServiceBundles(Log);
				Pages.createAccountManagementPage.selectServiceBundles(testdatamap);
				Pages.createAccountManagementPage.selectServicesFromAllServices(testdatamap);
				Pages.createAccountManagementPage.moveSelectedServices(Log);
				Pages.createAccountManagementPage.verifySelectedServices(testdatamap);
				Pages.createAccountManagementPage.selectServiceProviders(testdatamap);
				Pages.createAccountManagementPage.moveSelectedServiceProviders(Log);
				Pages.createAccountManagementPage.verifySelectedServiceProviders(testdatamap);
				Pages.createAccountManagementPage.selectStatusDropdownValue(testdatamap);
				Pages.createAccountManagementPage.clickOnSaveButton();
				Pages.accountManagementPage.searchCompanyName(testdatamap);
				Pages.accountManagementPage.clickOnActionIcon();
				Pages.accountManagementPage.clickOnDeleteButton(Log);
				Pages.accountManagementPage.verifyAccountDeletedToastMessage(testdatamap,Log);
