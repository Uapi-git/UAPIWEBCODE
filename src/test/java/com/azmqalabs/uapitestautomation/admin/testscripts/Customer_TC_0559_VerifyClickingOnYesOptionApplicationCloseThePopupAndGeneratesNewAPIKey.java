/**
*
* Test Script Name                      : Customer_TC_0559_VerifyClickingOnYesOptionApplicationCloseThePopupAndGeneratesNewAPIKey
* TestDataSheet                         : Customer_TC_0559
* Objective                             : Verify whether on click on 'Yes' option, application close the popup and generates new API Key tab in Profile screen
* Version                               : 1.0
...
Customer_TC_0559_VerifyClickingOnYesOptionApplicationCloseThePopupAndGeneratesNewAPIKey {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0559";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0559_VerifyClickingOnYesOptionApplicationCloseThePopupAndGeneratesNewAPIKey(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerProfilePage.clickOnYesInRegenerateApiKeyPopup();
				Pages.customerProfilePage.verifyApiKeyPageIsDisplayed(Log);
				Pages.customerProfilePage.verifyApiKeyChangedSuccessfully(apiKeyValue,Log);
