/**
 * Test Script Name                      : CustPortal_TC_0508_VerifyWhetherApplicationAllowsUserToClickOnCancelButtonUnderEditAccountScreenOnClickApplicationDiscardTheChangesAndCloseTheEditAccountScreenAndRedirectsToUserManagementPage.
 * Test data sheet Name                  : CustPortal_TC_0508
 * Objective                             : Verify whether Application allows user to click on 'Cancel' button under Edit Account screen, on click Application  discard the changes and close the 'Edit Account' screen and redirects to 'User Management page.
 * Version                               : 1.0
...
public class CustPortal_TC_0508_VerifyWhetherApplicationAllowsUserToClickOnCancelButtonUnderEditAccountScreenOnClickApplicationDiscardTheChangesAndCloseTheEditAccountScreenAndRedirectsToUserManagementPage {
    // DECLARATION SECTION
    static String TestDataTab = "CustPortal_TC_0508";
    ...
    public CustPortal_TC_0508_VerifyWhetherApplicationAllowsUserToClickOnCancelButtonUnderEditAccountScreenOnClickApplicationDiscardTheChangesAndCloseTheEditAccountScreenAndRedirectsToUserManagementPage(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.customerUserManagementPage.parseUserManagementGridData();
            Pages.customerUserManagementPage.backToFirstPageAfterParse();
            ...
            Pages.customerEditUserPage.modifyDataInEditUser(testdatamap,Log);
            Pages.customerEditUserPage.clickOnCancelBtn(Log);
            Pages.customerEditUserPage.clickOnCancelBtnInAreYouSureYouWantToCancelPopup();
            Pages.customerUserManagementPage.verifyUserRedirectedToUserManagementScreen();
            Pages.customerUserManagementPage.clickOnFirstRecordActionButton(Log);
            Pages.customerUserManagementPage.clickOnView(Log);
            Pages.customerUserManagementPage.verifyViewUserPageDetails(1);
