/**
*
* Test Script Name                      : Customer_TC_0364_VerifyWhetherTheApplicationAddToPriceConsumptionAndDedicateFromAvailableAmountEveryTimeTheUserExecuteAServiceRegardlessSuccessfullyOrFailureDependingOnTheSettingsInAdminPortal
* TestDataSheet                         : CustPortal_TC_0364
* Objective                             : Verify whether the Application add to 'Price Consumption' and dedicate from 'Available Amount' every time the user execute a service regardless successfully or failure depending on the settings in admin portal.
* Version                               : 1.0
...
public class Customer_TC_0364_VerifyWhetherTheApplicationAddToPriceConsumptionAndDedicateFromAvailableAmountEveryTimeTheUserExecuteAServiceRegardlessSuccessfullyOrFailureDependingOnTheSettingsInAdminPortal {

	// DECLARATION SECTION
	  static String TestDataTab="CustPortal_TC_0364";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0364_VerifyWhetherTheApplicationAddToPriceConsumptionAndDedicateFromAvailableAmountEveryTimeTheUserExecuteAServiceRegardlessSuccessfullyOrFailureDependingOnTheSettingsInAdminPortal(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.customerProfilePage.clickOnUseMyCredentialsToggleInConnectivityTabIfToggleIsOff(testdatamap,Log);
				...
				String ConsumptionValue=Pages.customerPackageManagementPage.getTransactionConsumption();
				// Parse the String to an integer
				int intValue = Integer.parseInt(ConsumptionValue);
