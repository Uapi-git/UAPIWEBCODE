/**
 *
 * Test Script Name                      : Admin_TC_0273_VerifyWhetherUAPIAdminApplicationDisplaysAnErrorMessageAsPleaseSelectYearWhenUserSelectsOnlyMonthValueInSearchByMonthFilter.
 * Test data sheet Name                  : Admin_TC_0273
 * Objective                             : Verify whether UAPI Admin Application displays an error message as 'Please select year', when user selects only month value in 'Search by Month' filter.
 * Version                               : 1.0
...
public class Admin_TC_0273_VerifyWhetherUAPIAdminApplicationDisplaysAnErrorMessageAsPleaseSelectYearWhenUserSelectsOnlyMonthValueInSearchByMonthFilter {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0273";
    ...
    public Admin_TC_0273_VerifyWhetherUAPIAdminApplicationDisplaysAnErrorMessageAsPleaseSelectYearWhenUserSelectsOnlyMonthValueInSearchByMonthFilter(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.clearSearchByYearValue(testdatamap,Log);
            Pages.reportsPage.verifyPleaseSelectYearErrorMSG();
