/**
 * Test Script Name                      : CustPortal_TC_0394_VerifyWhetherOnAddPackageScreenAnnualSubscriptionTierTabIsDefaultSelectedVerifyWhetherOnAddPackageScreenAnnualSubscriptionTierTabIsDefaultSelected.
 * Test data sheet Name                  : CustPortal_TC_0394
 * Objective                             : Verify whether on Add Package screen, Annual Subscription Tier tab is default selected.
 * Version                               : 1.0
...
public class CustPortal_TC_0394_VerifyWhetherOnAddPackageScreenAnnualSubscriptionTierTabIsDefaultSelectedVerifyWhetherOnAddPackageScreenAnnualSubscriptionTierTabIsDefaultSelected {
// DECLARATION SECTION
static String TestDataTab = "CustPortal_TC_0394";
...
public CustPortal_TC_0394_VerifyWhetherOnAddPackageScreenAnnualSubscriptionTierTabIsDefaultSelectedVerifyWhetherOnAddPackageScreenAnnualSubscriptionTierTabIsDefaultSelected(Map<Object, Object> testdatamap) {
...
public void myTest() throws Exception {
    try {
        ...
        Pages.customerAddPackagePage.verifyAnnualSubscriptionTiersTabSelectedByDefault(Log);
