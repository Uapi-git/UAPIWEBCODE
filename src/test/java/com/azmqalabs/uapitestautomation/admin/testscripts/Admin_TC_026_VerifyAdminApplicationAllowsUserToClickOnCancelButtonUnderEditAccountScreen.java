/**
*
* Test Script Name                      : Admin_TC_026_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditAccountScreen
* TestDataSheet                         : Admin_TC_026
* Objective                             : Verify whether UAPI Admin application allows user to click on 'Cancel' button under Edit Account screen, on click application discard the changes and close the 'Edit Account' screen and redirects to 'Account Management page.
* Version                               : 1.0
...
public class Admin_TC_026_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditAccountScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_026";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_026_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditAccountScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.accountManagementPage.clickOnEditButton(Log);
				Pages.editAccountManagementPage.verifyEditAccountManagementPageIsDisplayed(Log);
				String unifiedNationalNumber=Pages.editAccountManagementPage.getUnifiedNationalNumber();
				Pages.editAccountManagementPage.enterUnifiedNationalNumber(testdatamap);
				Pages.editAccountManagementPage.clickOnCancel(Log);
				Pages.accountManagementPage.verifyAccountManagementScreenDisplayed(testdatamap,Log);
				Pages.accountManagementPage.searchCompanyName(testdatamap);
				Pages.accountManagementPage.clickOnActionIcon();
				Pages.accountManagementPage.clickOnEditButton(Log);
				Pages.editAccountManagementPage.verifyEditAccountManagementPageIsDisplayed(Log);
				Pages.editAccountManagementPage.verifyUnifiedNationalNumberAfterClickingCancelInEditAccountManagementScreen(unifiedNationalNumber,Log);
