/**
*
* Test Script Name                      : Admin_TC_0148_VerifyApplicationAllowsUserToEditServiceProviderConnectivityCredentialsForMasdrServiceProviders
* TestDataSheet                         : Admin_TC_0148_Masdr
* Objective                             : Verify whether UAPI Admin Application allows user to edit below details under the 'Service provider connectivity credentials' popup box For (ETIMAD, MASDR, FINTECH, LEAN TECH)
* Version                               : 1.0
...
public class Admin_TC_0148_VerifyApplicationAllowsUserToEditServiceProviderConnectivityCredentialsForMasdrServiceProviders {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0148_Masdr";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0148_VerifyApplicationAllowsUserToEditServiceProviderConnectivityCredentialsForMasdrServiceProviders(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.editServiceProviderListPage.verifyServiceProviderConnectivityPopupEditableForMasdr(testdatamap,Log);
