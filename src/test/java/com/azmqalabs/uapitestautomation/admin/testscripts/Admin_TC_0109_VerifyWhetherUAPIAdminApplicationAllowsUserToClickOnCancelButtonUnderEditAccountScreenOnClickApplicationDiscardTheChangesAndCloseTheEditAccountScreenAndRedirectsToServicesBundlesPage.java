/**
 * Test Script Name                      : Admin_TC_0109_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnCancelButtonUnderEditAccountScreenOnClickApplicationDiscardTheChangesAndCloseTheEditAccountScreenAndRedirectsToServicesBundlesPage.
 * Test data sheet Name                  : Admin_TC_0109
 * Objective                             : Verify whether UAPI Admin application allows user to click on 'Cancel' button under Edit Account screen, on click application discard the changes and close the 'Edit Account' screen and redirects to 'Services Bundles page.
 * Version                               : 1.0
...
public class Admin_TC_0109_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnCancelButtonUnderEditAccountScreenOnClickApplicationDiscardTheChangesAndCloseTheEditAccountScreenAndRedirectsToServicesBundlesPage {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0109";
    ...
    public Admin_TC_0109_VerifyWhetherUAPIAdminApplicationAllowsUserToClickOnCancelButtonUnderEditAccountScreenOnClickApplicationDiscardTheChangesAndCloseTheEditAccountScreenAndRedirectsToServicesBundlesPage(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.editPackagePage.modifyChangesInEditPageAndClickOnCancelButton(testdatamap,Log);
            Pages.packageManagementPage.verifyNewlyAddedPackageDisplayedInTable(testdatamap);
            Pages.packageManagementPage.verifyUserRedirectedToServicesBundlesScreen();
