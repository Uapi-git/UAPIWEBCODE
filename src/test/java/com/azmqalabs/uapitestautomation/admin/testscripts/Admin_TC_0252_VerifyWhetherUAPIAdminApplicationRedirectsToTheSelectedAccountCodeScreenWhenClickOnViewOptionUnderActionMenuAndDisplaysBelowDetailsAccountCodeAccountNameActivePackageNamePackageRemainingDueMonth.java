/**
 *
 * Test Script Name                      : Admin_TC_0252_VerifyWhetherUAPIAdminApplicationRedirectsToTheSelectedAccountCodeScreenWhenClickOnViewOptionUnderActionMenuAndDisplaysBelowDetailsAccountCodeAccountNameActivePackageNamePackageRemainingDueMonth.
 * Test data sheet Name                  : Admin_TC_0252
 * Objective                             : Verify whether UAPI Admin Application redirects to the selected account code screen when click on 'View' option under Action menu and displays below details - Account Code,Account Name,Active Package Name,Package Remaining,Due Month
 * Version                               : 1.0
...
public class Admin_TC_0252_VerifyWhetherUAPIAdminApplicationRedirectsToTheSelectedAccountCodeScreenWhenClickOnViewOptionUnderActionMenuAndDisplaysBelowDetailsAccountCodeAccountNameActivePackageNamePackageRemainingDueMonth {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0252";
    ...
    public Admin_TC_0252_VerifyWhetherUAPIAdminApplicationRedirectsToTheSelectedAccountCodeScreenWhenClickOnViewOptionUnderActionMenuAndDisplaysBelowDetailsAccountCodeAccountNameActivePackageNamePackageRemainingDueMonth(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.parseReportsConsumptionDetailsGridData("GridData");
            Pages.reportsPage.clickOnFirstRecordActionButton(Log);
            Pages.reportsPage.clickOnView(Log);
            Pages.reportsPage.verifySelectedAccountCodeAndFieldsAfterClickOnView(1);
