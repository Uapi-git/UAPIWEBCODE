/**
*
* Test Script Name                      : Admin_TC_0152_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditServiceProviderListScreen
* TestDataSheet                         : Admin_TC_0152
* Objective                             : Verify whether UAPI Admin application allows user to click on 'Cancel' button under Edit Service Provider screen, on click application discard the changes and close the 'Edit Service Provider' screen and redirects to 'Service Provider List' page
* Version                               : 1.0
...
public class Admin_TC_0152_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditServiceProviderListScreenRedirectsToServiceProviderListScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0152";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0152_VerifyAdminApplicationAllowsUserToClickOnCancelButtonUnderEditServiceProviderListScreenRedirectsToServiceProviderListScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				String descriptionText=Pages.editServiceProviderListPage.getDescriptionText();
				Pages.editServiceProviderListPage.enterDescription(testdatamap);
				Pages.editServiceProviderListPage.clickOnCancel();
				Pages.serviceManagementProvidersListPage.verifyServiceProviderListPageIsDisplayed(Log);
				Pages.serviceManagementProvidersListPage.clickOnActionButton(Log);
				Pages.serviceManagementProvidersListPage.clickOnView(Log);
				Pages.serviceManagementProvidersListPage.verifyApplicationDiscardChangesAndRedirectsToServiceProviderListPage(descriptionText);
