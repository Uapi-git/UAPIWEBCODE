/**
 *
 * Test Script Name                      : Admin_TC_0312_TC_0314_VerifyWhetherUAPIAdminApplicationAllowsUserToSearchUserDetailsWithBelowSearchCriteriaSSearchWithFirstNameLastNameAndEmailID.
 * Test data sheet Name                  : Admin_TC_0312_TC_0314
 * Objective                             : 1.Verify whether UAPI Admin Application allows user to search User details with below search criteria's -Search with First Name, Last Name and Email ID. 2.Verify whether UAPI Admin Application filters the User data based on the search input entered in 'Search with First Name, Last Name and Email ID' and displays the results.
 * Version                               : 1.0
...
public class Admin_TC_0312_TC_0314_VerifyWhetherUAPIAdminApplicationAllowsUserToSearchUserDetailsWithBelowSearchCriteriaSSearchWithFirstNameLastNameAndEmailID {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0312_TC_0314";
    ...
    public Admin_TC_0312_TC_0314_VerifyWhetherUAPIAdminApplicationAllowsUserToSearchUserDetailsWithBelowSearchCriteriaSSearchWithFirstNameLastNameAndEmailID(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.userManagementPage.searchUser(testdatamap,Log);
            Pages.userManagementPage.parseUserManagementGridData("Grid Data");
            Pages.userManagementPage.verifyGridRecordData(1,testdatamap,Log);
