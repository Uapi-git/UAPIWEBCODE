/**
*
* Test Script Name                      : Customer_TC_0558_VerifyClickingOnNoOptionApplicationCloseThePopupAndRedirectsOnAPIKeyTab
* TestDataSheet                         : Customer_TC_0558
* Objective                             : Verify whether on click on 'No' option, application close the popup and redirects on 'API Key' tab in Profile screen
* Version                               : 1.0
...
Customer_TC_0558_VerifyClickingOnNoOptionApplicationCloseThePopupAndRedirectsOnAPIKeyTab {

	// DECLARATION SECTION
	  static String TestDataTab="Customer_TC_0558";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Customer_TC_0558_VerifyClickingOnNoOptionApplicationCloseThePopupAndRedirectsOnAPIKeyTab(Map<Object, Object> testdatamap){
