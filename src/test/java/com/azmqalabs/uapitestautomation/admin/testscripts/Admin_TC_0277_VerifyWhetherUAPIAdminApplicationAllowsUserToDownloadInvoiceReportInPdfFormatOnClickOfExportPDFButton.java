/**
 *
 * Test Script Name                      : Admin_TC_0277_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadInvoiceReportInPdfFormatOnClickOfExportPDFButton.
 * Test data sheet Name                  : Admin_TC_0277
 * Objective                             : Verify whether UAPI Admin Application allows user to download invoice report in pdf format on click of 'Export PDF' button.
 * Version                               : 1.0
...
public class Admin_TC_0277_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadInvoiceReportInPdfFormatOnClickOfExportPDFButton {
    // DECLARATION SECTION
    static String TestDataTab = "Admin_TC_0277";
    ...
    public Admin_TC_0277_VerifyWhetherUAPIAdminApplicationAllowsUserToDownloadInvoiceReportInPdfFormatOnClickOfExportPDFButton(Map<Object, Object> testdatamap) {
    ...
    public void myTest() throws Exception {
        try {
            ...
            Pages.reportsPage.clickOnExportPDFButton(Log);
            Pages.reportsPage.verifyDownloadedFileFormat("ConsumptionReport_All_Accounts","pdf");
