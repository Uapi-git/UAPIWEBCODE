/**
*
* Test Script Name                      : Admin_TC_0211_VerifyAdminApplicationFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceTypeFilterInInvoiceManagementScreen
* TestDataSheet                         : Admin_TC_0211
* Objective                             : Verify whether UAPI Admin Application filters the Invoice data based on the search option selection in 'Select Invoice Type' filter and displays the results
* Version                               : 1.0
...
public class Admin_TC_0211_VerifyAdminApplicationFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceTypeFilterInInvoiceManagementScreen {

	// DECLARATION SECTION
	  static String TestDataTab="Admin_TC_0211";
	  ...
	  DBUtil DBUtil;
	    ...
	    public Admin_TC_0211_VerifyAdminApplicationFiltersTheInvoiceDataBasedOnTheSearchOptionSelectionInSelectInvoiceTypeFilterInInvoiceManagementScreen(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
				...
				Pages.invoiceManagementPage.enterInvoiceTypeInSearchInvoiceTypeSearchOption(testdatamap,Log);
